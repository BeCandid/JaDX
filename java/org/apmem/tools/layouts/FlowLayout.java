...
public class FlowLayout extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        private void a(Context context, AttributeSet attributeSet) {
            TypedArray a = context.obtainStyledAttributes(attributeSet, aph$a.FlowLayout_LayoutParams);
            try {
                this.a = a.getBoolean(aph$a.FlowLayout_LayoutParams_layout_newLine, false);
                this.b = a.getInt(aph$a.FlowLayout_LayoutParams_android_layout_gravity, 0);
                this.c = a.getFloat(aph$a.FlowLayout_LayoutParams_layout_weight, -1.0f);
            } finally {
                a.recycle();
            }
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.a.clear();
        apg currentLine = new apg(controlMaxLength);
        ...
        for (i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (newLine) {
                    currentLine = new apg(controlMaxLength);
        ...
        for (i = 0; i < linesCount; i++) {
            contentLength = Math.max(contentLength, ((apg) this.a.get(i)).c());
        }
    ...
    private void a(List<apg> lines) {
        int prevLinesThickness = 0;
        int linesCount = lines.size();
        for (int i = 0; i < linesCount; i++) {
            apg line = (apg) lines.get(i);
    ...
    private void a(List<apg> lines, int realControlLength, int realControlThickness) {
        int linesCount = lines.size();
        if (linesCount > 0) {
            int totalWeight = linesCount;
            apg lastLine = (apg) lines.get(linesCount - 1);
