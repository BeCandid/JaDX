...
public class apf {
    ...
    public static String a(String str) {
        return apf.b(str, null);
    }

    public static String b(String str, char... delimiters) {
        return (apb.a(str) || (delimiters == null ? -1 : delimiters.length) == 0) ? str : apf.a(str.toLowerCase(), delimiters);
    }
