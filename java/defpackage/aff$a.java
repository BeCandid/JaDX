...
public abstract class aff$a extends Binder implements aff {
    public static aff a(IBinder iBinder) {
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof aff)) ? new aff$a$a(iBinder) : (aff) queryLocalInterface;
    }
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        ...
        switch (code) {
            ...
            case uu$h.com_facebook_like_view_com_facebook_horizontal_alignment /*5*/:
                data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                d = a(aff$a.a(data.readStrongBinder()));
                reply.writeNoException();
                if (d) {
                    i = 1;
                }
