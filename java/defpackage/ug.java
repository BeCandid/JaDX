...
class ug {
    ...
    ug(SharedPreferences sharedPreferences, ug$a tokenCachingStrategyFactory) {
        this.a = sharedPreferences;
        this.b = tokenCachingStrategyFactory;
    }

    public ug() {
        this(ul.f().getSharedPreferences("com.facebook.AccessTokenManager.SharedPreferences", 0), new ug$a());
    }
    ...
    public void a(AccessToken accessToken) {
        wf.a((Object) accessToken, "accessToken");
        try {
