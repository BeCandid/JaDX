...
public abstract class abd extends abi implements OnCancelListener {
    protected boolean a;
    protected boolean b;
    protected final xd c;
    ...
    L_0x0047:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: abd.a(int, int, android.content.Intent):void");
    }
    ...
    public void b(ConnectionResult connectionResult, int i) {
        if (!this.b) {
            ...
            this.g.post(new abd$a(this, null));
        }
    }
