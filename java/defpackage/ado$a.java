    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        ...
        switch (code) {
            ...
            case ha$a.Toolbar_titleMarginTop /*15*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                a(aev$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case ha$a.Toolbar_titleMarginBottom /*16*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                a(aeu$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case ha$a.Toolbar_collapseIcon /*18*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                StreetViewPanoramaOrientation a3 = a((aag) aag$a.zzbs(data.readStrongBinder()));
                reply.writeNoException();
                if (a3 != null) {
                    reply.writeInt(1);
            ...
            case ha$a.Toolbar_collapseContentDescription /*19*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                aag a4 = a(data.readInt() != 0 ? StreetViewPanoramaOrientation.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a4 != null) {
                    iBinder = a4.asBinder();
                }
            ...
            case HttpEngine.MAX_FOLLOW_UPS /*20*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                a(aex$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case 1598968902:
