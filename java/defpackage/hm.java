...
public class hm extends hd<Message> {
    private Context d;
    private User e;
    private User f;
    ...
    public hm(Context context) {
        this.d = context;
        ((BaseActivity) context).addToSubscriptionList(ix.a().a(in$aj.class, new hm$1(this)));
    }
    ...
    public jc b(ViewGroup parent, int viewType) {
        switch (viewType) {
            case uu$h.com_facebook_login_view_com_facebook_confirm_logout /*0*/:
                return new jh(LayoutInflater.from(parent.getContext()).inflate(2130968699, parent, false), 0);
            case uu$h.com_facebook_profile_picture_view_com_facebook_is_cropped /*1*/:
                return new jh(LayoutInflater.from(parent.getContext()).inflate(2130968698, parent, false), 1);
            case uu$h.com_facebook_login_view_com_facebook_logout_text /*2*/:
                return new MessagePostViewHolder(LayoutInflater.from(parent.getContext()).inflate(2130968664, parent, false), (MessageActivity) this.d);
            case uu$h.com_facebook_login_view_com_facebook_tooltip_mode /*3*/:
                return new MessagesHeaderViewHolder(LayoutInflater.from(parent.getContext()).inflate(2130968701, parent, false));
            default:
                return null;
        }
    }
    ...
    public void a(jc holder, int position) {
        ...
        if (holder instanceof jh) {
            jh messageHolder = (jh) holder;
            ...
            if (this.e != null) {
                if (message.sent_time == 0 || (prevMessage != null && message.sent_time - prevMessage.sent_time < 6000)) {
                    jh.a(messageHolder, message, prevMessage, this.f, this.e, false, this.d, this);
                } else {
                    jh.a(messageHolder, message, prevMessage, this.f, this.e, true, this.d, this);
                }
            }
