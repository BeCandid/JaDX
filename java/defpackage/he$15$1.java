    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 2131624830:
                ...
                break;
            case 2131624831:
                jb.a(this.a.b.f, "Delete this comment?", "Once you delete this comment you can never see it again.", "Yes", "No", 16843605, false, new in$h(this.a.b.f, this.a.a.comment_id, this.a.a.post_id)).show();
                break;
            case 2131624832:
                if (this.a.a.messaging_blocked == null) {
                    ...
                    new Builder(this.a.b.f).setMessage(this.a.a.messaging_disabled).setPositiveButton(2131230895, null).show();
                    break;
                }
                new Builder(this.a.b.f).setMessage(this.a.a.messaging_blocked).setPositiveButton(2131230895, null).show();
                break;
            case 2131624833:
                dialog = jb.a(this.a.b.f, "Report This Comment?", null, "Report Comment", "Cancel", -1, true, new in$ai(this.a.b.f, this.a.a.comment_id)).create();
                dialog.setOnShowListener(new he$15$1$1(this));
                dialog.show();
                break;
            case 2131624834:
                dialog = jb.a(this.a.b.f, "Delete this comment?", null, "Delete Comment", "Cancel", 16843605, true, new in$i(this.a.b.f, this.a.a.comment_id, this.a.a.post_id)).create();
