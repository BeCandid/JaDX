...
public final class aip extends ail {
    ...
    public aip(Boolean bool) {
        a((Object) bool);
    }

    public aip(Number number) {
        a((Object) number);
    }

    public aip(String string) {
        a((Object) string);
    }

    aip(Object primitive) {
        a(primitive);
    }
    ...
    void a(Object primitive) {
        ...
        boolean z = (primitive instanceof Number) || aip.b(primitive);
        aiy.a(z);
        this.b = primitive;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.b == null) {
            ...
            return true;
        } else if (aip.a(this) && aip.a(other)) {
    ...
    private static boolean a(aip primitive) {
