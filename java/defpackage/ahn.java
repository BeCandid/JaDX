...
public class ahn implements Creator<AuthAccountResult> {
    public static void a(AuthAccountResult authAccountResult, Parcel parcel, int i) {
        int a = xw.a(parcel);
        xw.a(parcel, 1, authAccountResult.a);
        xw.a(parcel, 2, authAccountResult.b());
        xw.a(parcel, 3, authAccountResult.c(), i, false);
        xw.a(parcel, a);
    }
