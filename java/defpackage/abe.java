...
public abstract class abe<R extends xk> extends xi<R> {
    static final ThreadLocal<Boolean> a = new abe$1();
    protected final abe$a<R> b = new abe$a(Looper.getMainLooper());
    protected final WeakReference<xh> c = new WeakReference(null);
    ...
    private void a(R r) {
        ...
        if (this.k) {
            ...
            this.b.a();
            this.b.a(this.g, b());
        } else if (this.h instanceof xj) {
            this.i = new abe$b(this, null);
        }
    ...
    private R b() {
        ...
        synchronized (this.d) {
            ...
            xz.a(z, (Object) "Result has already been consumed.");
            xz.a(e(), (Object) "Result is not ready.");
            r = this.h;
            this.h = null;
            this.g = null;
            this.j = true;
    ...
    public final void a(defpackage.xl<? super R> r6) {
        /*
        r5 = this;
        r0 = 1;
        r1 = 0;
    ...
    L_0x0011:
        ...
        defpackage.xz.a(r2, r4);	 Catch:{ all -> 0x0027 }
        r2 = r5.n;	 Catch:{ all -> 0x0027 }
        if (r2 != 0) goto L_0x002c;
    L_0x001a:
        r1 = "Cannot set callbacks if then() has been called.";
        defpackage.xz.a(r0, r1);	 Catch:{ all -> 0x0027 }
    ...
    L_0x003f:
        ...
        goto L_0x003d;
        */
        throw new UnsupportedOperationException("Method not decompiled: abe.a(xl):void");
    }
    ...
    public final void b(R r) {
        ...
        synchronized (this.d) {
            ...
            xz.a(!e(), (Object) "Results have already been set");
            if (this.j) {
                z = false;
            }
            xz.a(z, (Object) "Result has already been consumed");
    ...
    L_0x0016:
        ...
        defpackage.abe.c(r0);	 Catch:{ all -> 0x0029 }
        r0 = 1;
    ...
    L_0x002c:
        ...
        goto L_0x0016;
        */
        throw new UnsupportedOperationException("Method not decompiled: abe.f():void");
    }

    public boolean g() {
        boolean h;
        synchronized (this.d) {
            if (((xh) this.c.get()) == null || !this.o) {
                f();
            }
            h = h();
        }
