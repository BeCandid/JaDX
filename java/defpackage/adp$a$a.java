...
class adp$a$a implements adp {
    private IBinder a;

    adp$a$a(IBinder iBinder) {
        this.a = iBinder;
    }

    public aag a(aag inflaterWrapper, aag containerWrapper, Bundle savedInstanceState) throws RemoteException {
    ...
    public ado a() throws RemoteException {
        ...
        try {
            ...
            obtain2.readException();
            ado a = ado$a.a(obtain2.readStrongBinder());
            return a;
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public void a(aag activityWrapper, StreetViewPanoramaOptions options, Bundle savedInstanceState) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
    ...
    public void a(adv callback) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
