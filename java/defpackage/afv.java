...
public class afv implements Creator<StreetViewPanoramaLocation> {
    public static void a(StreetViewPanoramaLocation streetViewPanoramaLocation, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, streetViewPanoramaLocation.a());
        xw.a(parcel, 2, streetViewPanoramaLocation.a, i, false);
        xw.a(parcel, 3, streetViewPanoramaLocation.b, i, false);
        xw.a(parcel, 4, streetViewPanoramaLocation.c, false);
        xw.zzI(parcel, zzav);
    }
