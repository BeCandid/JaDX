...
class lf implements kn {
    ...
    public lf(String id, kn signature, int width, int height, kp cacheDecoder, kp decoder, kr transformation, kq encoder, pf transcoder, km sourceEncoder) {
        this.a = id;
        this.j = signature;
        this.b = width;
        this.c = height;
