...
public class kd {
    ...
    public synchronized Bitmap f() {
        ...
        synchronized (this) {
            ...
            if (this.q != 1 && this.q != 2) {
                this.q = 0;
                ke currentFrame = (ke) this.m.e.get(this.k);
                ke previousFrame = null;
                int previousIndex = this.k - 1;
                if (previousIndex >= 0) {
                    previousFrame = (ke) this.m.e.get(previousIndex);
                }
    ...
    public void a(kf header, byte[] data) {
        this.m = header;
        this.l = data;
        this.q = 0;
        this.k = -1;
    ...
    private Bitmap a(ke currentFrame, ke previousFrame) {
        int c;
        int width = this.m.f;
        int height = this.m.g;
        int[] dest = this.j;
