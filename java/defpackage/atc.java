...
public class atc implements OnTouchListener, OnGlobalLayoutListener, atb, ath {
    ...
    private static boolean b(ScaleType scaleType) {
        ...
        switch (atc$2.a[scaleType.ordinal()]) {
    ...
    private static void b(ImageView imageView) {
        if (imageView != null && !(imageView instanceof atb) && !ScaleType.MATRIX.equals(imageView.getScaleType())) {
    ...
    public atc(ImageView imageView, boolean zoomable) {
        this.b = 200;
        this.e = 1.0f;
        this.f = 1.75f;
        this.g = 3.0f;
        ...
        if (!imageView.isInEditMode()) {
            this.l = ati.a(imageView.getContext(), this);
            this.k = new GestureDetector(imageView.getContext(), new atc$1(this));
            this.k.setOnDoubleTapListener(new ata(this));
            this.D = 0.0f;
            b(zoomable);
        }
    }
    ...
    public void a(atc$e onScaleChangeListener) {
        this.v = onScaleChangeListener;
    }

    public void a(atc$f onSingleFlingListener) {
    ...
    public ImageView c() {
        ...
        if (imageView == null) {
            a();
            atj.a().b("PhotoViewAttacher", "ImageView no longer exists. You should not use this PhotoViewAttacher any more.");
        }
        return imageView;
    }
    ...
    public void a(float dx, float dy) {
        if (!this.l.a()) {
            if (d) {
                atj.a().a("PhotoViewAttacher", String.format("onDrag: dx: %.2f. dy: %.2f", new Object[]{Float.valueOf(dx), Float.valueOf(dy)}));
            }
    ...
    public void a(float startX, float startY, float velocityX, float velocityY) {
        if (d) {
            atj.a().a("PhotoViewAttacher", "onFling. sX: " + startX + " sY: " + startY + " Vx: " + velocityX + " Vy: " + velocityY);
        }
        ImageView imageView = c();
        this.B = new atc$b(this, imageView.getContext());
    ...
    public void a(float scaleFactor, float focusX, float focusY) {
        if (d) {
            atj.a().a("PhotoViewAttacher", String.format("onScale: scale: %.2f. fX: %.2f. fY: %.2f", new Object[]{Float.valueOf(scaleFactor), Float.valueOf(focusX), Float.valueOf(focusY)}));
        }
        ...
        switch (ev.getAction()) {
            case uu$h.com_facebook_login_view_com_facebook_confirm_logout /*0*/:
                if (parent != null) {
                    ...
                    atj.a().b("PhotoViewAttacher", "onTouch getParent() returned null");
                }
                p();
                break;
            case uu$h.com_facebook_profile_picture_view_com_facebook_is_cropped /*1*/:
            case uu$h.com_facebook_login_view_com_facebook_tooltip_mode /*3*/:
                if (g() < this.e) {
                    RectF rect = b();
                    if (rect != null) {
                        v.post(new atc$a(this, g(), this.e, rect.centerX(), rect.centerY()));
                        handled = true;
                        break;
                    }
                }
    ...
    public void c(float minimumScale) {
        atc.c(minimumScale, this.f, this.g);
        this.e = minimumScale;
    }

    public void d(float mediumScale) {
        atc.c(this.e, mediumScale, this.g);
        this.f = mediumScale;
    }

    public void e(float maximumScale) {
        atc.c(this.e, this.f, maximumScale);
        this.g = maximumScale;
    }

    public void b(float minimumScale, float mediumScale, float maximumScale) {
        atc.c(minimumScale, mediumScale, maximumScale);
        this.e = minimumScale;
        this.f = mediumScale;
        this.g = maximumScale;
    }
    ...
    public void a(atc$c listener) {
        this.r = listener;
    }

    public void a(atc$d listener) {
        this.s = listener;
    }
    ...
    public void a(float scale, float focalX, float focalY, boolean animate) {
        ...
        if (scale < this.e || scale > this.g) {
            atj.a().b("PhotoViewAttacher", "Scale must be within the range of minScale and maxScale");
        } else if (animate) {
            imageView.post(new atc$a(this, g(), scale, focalX, focalY));
        } else {
    ...
    public void a(ScaleType scaleType) {
        if (atc.b(scaleType) && scaleType != this.F) {
            this.F = scaleType;
            k();
        }
    }
