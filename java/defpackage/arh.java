...
public abstract class arh<E> extends arf<E> {
    private static final long e = ((long) (asd.a.arrayBaseOffset(long[].class) + (32 << (f - a))));
    private static final int f = (a + 3);
    protected final long[] d;

    static {
        if (8 == asd.a.arrayIndexScale(long[].class)) {
            return;
        }
    ...
    protected final void a(long[] buffer, long offset, long e) {
        asd.a.putOrderedLong(buffer, offset, e);
    }

    protected final long a(long[] buffer, long offset) {
        return asd.a.getLongVolatile(buffer, offset);
    }
}
