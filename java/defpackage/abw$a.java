...
public abstract class abw$a extends Binder implements abw {
    public abw$a() {
        attachInterface(this, "com.google.android.gms.flags.IFlagProvider");
    }

    public static abw asInterface(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.flags.IFlagProvider");
        return (queryLocalInterface == null || !(queryLocalInterface instanceof abw)) ? new abw$a$a(iBinder) : (abw) queryLocalInterface;
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case uu$h.com_facebook_profile_picture_view_com_facebook_is_cropped /*1*/:
                ...
                init(aag$a.a(parcel.readStrongBinder()));
