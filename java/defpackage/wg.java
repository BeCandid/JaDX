...
public class wg extends Dialog {
    private String a;
    private String b;
    private wg$c c;
    private WebView d;
    ...
    public wg(Context context, String url) {
        this(context, url, ul.l());
    }

    public wg(Context context, String url, int theme) {
        if (theme == 0) {
            theme = ul.l();
        }
        super(context, theme);
    ...
    public wg(Context context, String action, Bundle parameters, int theme, wg$c listener) {
        if (theme == 0) {
            theme = ul.l();
        }
        super(context, theme);
        ...
        parameters.putString("sdk", String.format(Locale.ROOT, "android-%s", new Object[]{ul.g()}));
        this.a = we.a(wc.a(), wc.d() + "/" + "dialog/" + action, parameters).toString();
        this.c = listener;
    }

    public void a(wg$c listener) {
        this.c = listener;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.e.setMessage(getContext().getString(uu$f.com_facebook_loading));
        this.e.setCanceledOnTouchOutside(false);
        this.e.setOnCancelListener(new wg$1(this));
    ...
    protected Bundle a(String urlString) {
        ...
        Bundle b = we.c(u.getQuery());
        b.putAll(we.c(u.getFragment()));
        return b;
    }
    ...
    private void e() {
        ...
        this.f.setOnClickListener(new wg$2(this));
        this.f.setImageDrawable(getContext().getResources().getDrawable(uu$c.com_facebook_close));
    ...
    private void a(int margin) {
        ...
        this.d = new wg$3(this, getContext().getApplicationContext());
        this.d.setVerticalScrollBarEnabled(false);
        this.d.setHorizontalScrollBarEnabled(false);
        this.d.setWebViewClient(new wg$b(this, null));
        ...
        this.d.setOnTouchListener(new wg$4(this));
