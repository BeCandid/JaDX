...
public class aal {
    ...
    protected aal(Context context, String str, Bundle bundle) {
    ...
    public static synchronized aal a(Context context, Bundle bundle) {
        aal aal;
        synchronized (aal.class) {
            ...
            if (g == null) {
                g = new aap(applicationContext);
                h = new aao(applicationContext);
            }
            f = Integer.toString(aal.a(applicationContext));
            aal = (aal) a.get(str);
            if (aal == null) {
                aal = new aal(applicationContext, str, bundle);
                a.put(str, aal);
            }
        }
        return aal;
