...
public class ahu implements Creator<SignInResponse> {
    public static void a(SignInResponse signInResponse, Parcel parcel, int i) {
        int a = xw.a(parcel);
        xw.a(parcel, 1, signInResponse.a);
        xw.a(parcel, 2, signInResponse.a(), i, false);
        xw.a(parcel, 3, signInResponse.b(), i, false);
        xw.a(parcel, a);
    }
