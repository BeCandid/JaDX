...
public class agf extends agd {
    private agf$a a;
    private b b;
    private final Set<c> c = new HashSet();
    private boolean d;

    protected agf(ahk ahk) {
        super(ahk);
    }
    ...
    private void b(String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        ...
        if (this.n.D()) {
            ...
            if (z && this.b != null && !j2) {
                ...
                Bundle a = s().a(str2, bundle, zo.a("_o"), z3);
                Bundle a2 = z2 ? a(a) : a;
    ...
    protected void a(String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        v().a(new agf$2(this, str, str2, j, bundle != null ? new Bundle(bundle) : new Bundle(), z, z2, z3, str3));
    }

    void a(String str, String str2, long j, Object obj) {
        v().a(new agf$3(this, str, str2, obj, j));
    }

    public void a(String str, String str2, Bundle bundle) {
        h();
        boolean z = this.b == null || ago.j(str2);
