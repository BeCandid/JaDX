...
public class afu implements Creator<StreetViewPanoramaLink> {
    public static void a(StreetViewPanoramaLink streetViewPanoramaLink, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, streetViewPanoramaLink.a());
        xw.a(parcel, 2, streetViewPanoramaLink.a, false);
        xw.a(parcel, 3, streetViewPanoramaLink.b);
        xw.zzI(parcel, zzav);
    }
