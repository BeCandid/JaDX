...
public class ace {
    ...
    public ace(Context context, int i, String str) {
        this(context, i, str, null, context == null ? null : context.getPackageName());
    }

    @SuppressLint({"UnwrappedWakeLock"})
    public ace(Context context, int i, String str, String str2, String str3) {
        this(context, i, str, str2, str3, null);
    }

    @SuppressLint({"UnwrappedWakeLock"})
    public ace(Context context, int i, String str, String str2, String str3, String str4) {
        this.k = true;
        xz.a(str, (Object) "Wake lock name can NOT be empty");
        this.f = i;
        this.h = str2;
        this.i = str4;
        this.j = context.getApplicationContext();
        if (aac.GOOGLE_PLAY_SERVICES_PACKAGE.equals(context.getPackageName())) {
            this.g = str;
        } else {
    ...
    L_0x0045:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: ace.a(java.lang.String):void");
    }
    ...
    L_0x0044:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: ace.a(java.lang.String, long):void");
    }
    ...
    public void a(WorkSource workSource) {
        if (workSource != null && zx.a(this.j)) {
            if (this.e != null) {
