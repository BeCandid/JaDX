...
public class agb implements Creator<StreetViewPanoramaOptions> {
    public static void a(StreetViewPanoramaOptions streetViewPanoramaOptions, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, streetViewPanoramaOptions.a());
        xw.a(parcel, 2, streetViewPanoramaOptions.g(), i, false);
        xw.a(parcel, 3, streetViewPanoramaOptions.j(), false);
        xw.a(parcel, 4, streetViewPanoramaOptions.h(), i, false);
        xw.a(parcel, 5, streetViewPanoramaOptions.i(), false);
        xw.a(parcel, 6, streetViewPanoramaOptions.b());
        xw.a(parcel, 7, streetViewPanoramaOptions.c());
        xw.a(parcel, 8, streetViewPanoramaOptions.d());
        xw.a(parcel, 9, streetViewPanoramaOptions.e());
        xw.a(parcel, 10, streetViewPanoramaOptions.f());
        xw.zzI(parcel, zzav);
    }
