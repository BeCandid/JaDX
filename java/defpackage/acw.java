...
public class acw implements Creator<PlaceLocalization> {
    public static void a(PlaceLocalization placeLocalization, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, placeLocalization.b, false);
        xw.a(parcel, 1000, placeLocalization.a);
        xw.a(parcel, 2, placeLocalization.c, false);
        xw.a(parcel, 3, placeLocalization.d, false);
        xw.a(parcel, 4, placeLocalization.e, false);
        xw.b(parcel, 5, placeLocalization.f, false);
        xw.zzI(parcel, zzav);
    }
