...
public class ov implements kq<on> {
    private static final ov$a a = new ov$a();
    private final kd$a b;
    private final ln c;
    private final ov$a d;

    public boolean a(defpackage.lj<defpackage.on> r19, java.io.OutputStream r20) {
...
*/
        ...
        r6 = (defpackage.on) r6;
        r12 = r6.c();
        r14 = r12 instanceof defpackage.no;
    ...
    L_0x0083:
        ...
        goto L_0x001e;
        */
        throw new UnsupportedOperationException("Method not decompiled: ov.a(lj, java.io.OutputStream):boolean");
    }

    public ov(ln bitmapPool) {
        this(bitmapPool, a);
    }

    ov(ln bitmapPool, ov$a factory) {
        this.c = bitmapPool;
        this.b = new om(bitmapPool);
        this.d = factory;
    }
    ...
    private kd a(byte[] data) {
        kg parser = this.d.a();
        parser.a(data);
        kf header = parser.b();
        kd decoder = this.d.a(this.b);
        decoder.a(header, data);
        decoder.a();
        return decoder;
    }

    private lj<Bitmap> a(Bitmap currentFrame, kr<Bitmap> transformation, on drawable) {
        lj<Bitmap> bitmapResource = this.d.a(currentFrame, this.c);
        lj<Bitmap> transformedResource = transformation.a(bitmapResource, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
