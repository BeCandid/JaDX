...
final class to$b extends to$j {
    private final long a;
    private final long b;
    private final String c;
    private final String d;

    public to$b(ua binaryImageData) {
        super(4, new to$j[0]);
    ...
    public int a() {
        ...
        return ((CodedOutputStream.b(3, sw.a(this.c)) + addrSize) + CodedOutputStream.b(2, this.b)) + CodedOutputStream.b(4, sw.a(this.d));
    }
