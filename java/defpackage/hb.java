...
public class hb extends hd<Notification> {
    ...
    public ji a(ViewGroup viewGroup, int i) {
        return new ji(LayoutInflater.from(viewGroup.getContext()).inflate(2130968714, viewGroup, false));
    }

    public void a(jc holder, int i) {
        Spannable spannable;
        ji notyHolder = (ji) holder;
        ...
        if (currItem.user_name == null || currItem.title.startsWith("Someone") || currItem.icon_color == null) {
            ...
            notyHolder.h.setText(io.a(currItem.icon_name));
        ...
        notyHolder.d.setText(ip.a(currItem.t_create));
        View itemView = ((ji) holder).itemView;
