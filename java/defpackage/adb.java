...
public class adb implements Creator<GeofencingRequest> {
    public static void a(GeofencingRequest geofencingRequest, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.c(parcel, 1, geofencingRequest.b(), false);
        xw.a(parcel, 1000, geofencingRequest.a());
        xw.a(parcel, 2, geofencingRequest.c());
        xw.zzI(parcel, zzav);
    }
