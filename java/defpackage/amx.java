...
public class amx implements ams {
    ...
    private aly e = new aly(this.d);
    private File f;

    public amx(Context context, File workingDirectory, String workingFileName, String targetDirectoryName) throws IOException {
        this.a = context;
