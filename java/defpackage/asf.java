...
public class asf<T> implements apm<T> {
    private final apm<? super T> a;
    private boolean b;
    private volatile boolean c;
    private asf$a d;
    private final NotificationLite<T> e = NotificationLite.a();

    public asf(apm<? super T> s) {
        this.a = s;
    }
    ...
    L_0x007d:
        ...
        goto L_0x0056;
        */
        throw new UnsupportedOperationException("Method not decompiled: asf.onNext(java.lang.Object):void");
    }
