...
public class aox extends aoy {
    ...
    public aox(boolean urlSafe) {
        this(76, a, urlSafe);
    }

    public aox(int lineLength) {
        this(lineLength, a);
    }

    public aox(int lineLength, byte[] lineSeparator) {
        this(lineLength, lineSeparator, false);
    }

    public aox(int lineLength, byte[] lineSeparator, boolean urlSafe) {
        int i;
        ...
        if (lineSeparator == null) {
            ...
            throw new IllegalArgumentException("lineSeparator must not contain base64 characters: [" + aoz.a(lineSeparator) + "]");
    ...
    void a(byte[] in, int inPos, int inAvail, aoy$a context) {
        if (!context.f) {
            byte[] buffer;
            int i;
            if (inAvail < 0) {
    ...
    void b(byte[] in, int inPos, int inAvail, aoy$a context) {
        if (!context.f) {
            byte[] buffer;
            int i;
            if (inAvail < 0) {
    ...
    public static byte[] a(byte[] binaryData) {
        return aox.a(binaryData, false);
    }

    public static byte[] a(byte[] binaryData, boolean isChunked) {
        return aox.a(binaryData, isChunked, false);
    }

    public static byte[] a(byte[] binaryData, boolean isChunked, boolean urlSafe) {
        return aox.a(binaryData, isChunked, urlSafe, Integer.MAX_VALUE);
    }
    ...
    public static byte[] a(byte[] binaryData, boolean isChunked, boolean urlSafe, int maxResultSize) {
        ...
        aox b64 = isChunked ? new aox(urlSafe) : new aox(0, a, urlSafe);
