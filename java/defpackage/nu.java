...
public abstract class nu implements np<InputStream> {
    public static final nu a = new nu$1();
    public static final nu b = new nu$2();
    public static final nu c = new nu$3();
    private static final Set<ImageType> d = EnumSet.of(ImageType.b, ImageType.c, ImageType.d);
    private static final Queue<Options> e = ri.a(0);
...
*/
    ...
    L_0x0087:
        ...
        goto L_0x0011;
        */
        throw new UnsupportedOperationException("Method not decompiled: nu.a(java.io.InputStream, com.bumptech.glide.load.DecodeFormat):android.graphics.Bitmap$Config");
    }
...
*/
    ...
    L_0x0067:
        ...
        goto L_0x005d;
        */
        throw new UnsupportedOperationException("Method not decompiled: nu.a(java.io.InputStream):boolean");
    }

    protected abstract int a(int i, int i2, int i3, int i4);

    public android.graphics.Bitmap a(java.io.InputStream r28, defpackage.ln r29, int r30, int r31, com.bumptech.glide.load.DecodeFormat r32) {
        /* JADX: method processing error */
/*
...
*/
    ...
    L_0x003d:
        ...
        r4 = defpackage.oe.a(r24);	 Catch:{ IOException -> 0x008b, all -> 0x0079 }
    ...
    L_0x00e8:
        ...
        r25 = defpackage.oe.a(r0, r1, r2);	 Catch:{ IOException -> 0x008b, all -> 0x0079 }
        r0 = r19;	 Catch:{ IOException -> 0x008b, all -> 0x0079 }
    ...
    L_0x0109:
        ...
        return r25;
        */
        throw new UnsupportedOperationException("Method not decompiled: nu.a(java.io.InputStream, ln, int, int, com.bumptech.glide.load.DecodeFormat):android.graphics.Bitmap");
    }
    ...
    private Bitmap a(rg is, RecyclableBufferedInputStream bufferedStream, Options options, ln pool, int inWidth, int inHeight, int sampleSize, DecodeFormat decodeFormat) {
        Config config = nu.a((InputStream) is, decodeFormat);
        options.inSampleSize = sampleSize;
        options.inPreferredConfig = config;
        if ((options.inSampleSize == 1 || 19 <= VERSION.SDK_INT) && nu.a((InputStream) is)) {
            nu.a(options, pool.b((int) Math.ceil(((double) inWidth) / ((double) sampleSize)), (int) Math.ceil(((double) inHeight) / ((double) sampleSize)), config));
        }
        return nu.b(is, bufferedStream, options);
    }

    public int[] a(rg is, RecyclableBufferedInputStream bufferedStream, Options options) {
        options.inJustDecodeBounds = true;
        nu.b(is, bufferedStream, options);
        options.inJustDecodeBounds = false;
        return new int[]{options.outWidth, options.outHeight};
    }

    private static Bitmap b(rg is, RecyclableBufferedInputStream bufferedStream, Options options) {
