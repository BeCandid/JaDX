...
class he$8 implements OnClickListener {
    ...
    he$8(he this$0, Comment comment) {
        this.b = this$0;
        this.a = comment;
    }
    ...
    public void onClick(View v) {
        if (this.a.messaging_blocked != null) {
            new Builder(this.b.f).setMessage(this.a.messaging_blocked).setPositiveButton(2131230895, null).show();
        } else if (this.a.messaging_disabled != null) {
            new Builder(this.b.f).setMessage(this.a.messaging_disabled).setPositiveButton(2131230895, null).show();
            ...
            new Builder(this.b.f).setTitle("Message User?").setMessage("Would you like to send this user a message?").setNegativeButton(this.b.f.getResources().getString(2131230890), null).setPositiveButton(this.b.f.getResources().getString(2131230953), new he$8$1(this)).create().show();
