...
public class ho extends hd<Group> {
    private Context d;
    ...
    public ho$a a(ViewGroup parent, int viewType) {
        return new ho$a(LayoutInflater.from(parent.getContext()).inflate(2130968742, parent, false));
    }

    public void a(jc holder, int position) {
        Group group = (Group) this.a.get(position);
        ho$a gHolder = (ho$a) holder;
