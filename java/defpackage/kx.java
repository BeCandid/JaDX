...
public class kx implements ku<InputStream> {
    private static final kx$b a = new kx$a(null);
    private final mj b;
    private final kx$b c;
    ...
    public kx(mj glideUrl) {
        this(glideUrl, a);
    }

    kx(mj glideUrl, kx$b connectionFactory) {
        this.b = glideUrl;
    ...
    private InputStream a(HttpURLConnection urlConnection) throws IOException {
        if (TextUtils.isEmpty(urlConnection.getContentEncoding())) {
            this.e = rc.a(urlConnection.getInputStream(), (long) urlConnection.getContentLength());
        } else {
