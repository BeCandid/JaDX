...
public abstract class adw$a extends Binder implements adw {
    public static adw a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
        return (queryLocalInterface == null || !(queryLocalInterface instanceof adw)) ? new adw$a$a(iBinder) : (adw) queryLocalInterface;
    }
