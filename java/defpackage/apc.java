...
public class apc {
    ...
    public apc a(Object lhs, Object rhs) {
        return a(lhs, rhs, null);
    }

    public apc a(Object lhs, Object rhs, Comparator<?> comparator) {
        if (this.a == 0 && lhs != rhs) {
            if (lhs == null) {
                this.a = -1;
            } else if (rhs == null) {
    ...
    public apc a(long lhs, long rhs) {
        if (this.a == 0) {
    ...
    public apc a(short lhs, short rhs) {
        if (this.a == 0) {
            int i = lhs < rhs ? -1 : lhs > rhs ? 1 : 0;
            this.a = i;
        }
    ...
    public apc a(char lhs, char rhs) {
        if (this.a == 0) {
            int i = lhs < rhs ? -1 : lhs > rhs ? 1 : 0;
            this.a = i;
        }
    ...
    public apc a(byte lhs, byte rhs) {
        if (this.a == 0) {
            int i = lhs < rhs ? -1 : lhs > rhs ? 1 : 0;
            this.a = i;
        }
    ...
    public apc a(double lhs, double rhs) {
        if (this.a == 0) {
    ...
    public apc a(float lhs, float rhs) {
        if (this.a == 0) {
    ...
    public apc a(boolean lhs, boolean rhs) {
        if (this.a == 0 && lhs != rhs) {
            if (lhs) {
                this.a = 1;
            } else {
