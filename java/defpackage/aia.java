...
public class aia {
    static Map<String, aia> a = new HashMap();
    static String f;
    private static aid g;
    private static aic h;
    Context b;
    KeyPair c;
    String d = "";
    long e;

    protected aia(Context context, String str, Bundle bundle) {
        this.b = context.getApplicationContext();
        this.d = str;
    }

    public static synchronized aia a(Context context, Bundle bundle) {
        aia aia;
        synchronized (aia.class) {
            ...
            if (g == null) {
                g = new aid(applicationContext);
                h = new aic(applicationContext);
            }
            f = Integer.toString(FirebaseInstanceId.b(applicationContext));
            aia = (aia) a.get(str);
            if (aia == null) {
                aia = new aia(applicationContext, str, bundle);
                a.put(str, aia);
            }
        }
        return aia;
