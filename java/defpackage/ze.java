...
public class ze {
    ...
    private ze() {
        ...
        this.g = new zh(1024, ((Long) zf$a.f.a()).longValue());
        this.i = new zh(1024, ((Long) zf$a.f.a()).longValue());
    }
    ...
    private static String a(int i, int i2) {
        ...
        int i3 = i2 + i;
        while (i < i3) {
            stringBuffer.append(ze.a(stackTrace, i)).append(" ");
            i++;
        }
    ...
    private void a(Context context, String str, int i, String str2, String str3, String str4, String str5) {
        ...
        context.startService(new Intent().setComponent(zg.a).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", connectionEvent));
    }
    ...
    private void a(Context context, String str, String str2, Intent intent, int i) {
        ...
        if (b() && this.g != null) {
            ...
            String str5;
            if (i != 4 && i != 1) {
                ServiceInfo b = ze.b(context, intent);
                if (b == null) {
    ...
    private boolean a(Context context, Intent intent) {
        ...
        return component != null ? zm.a(context, component.getPackageName()) : false;
    }

    private boolean a(String str, String str2, String str3, String str4) {
        return (this.c.contains(str) || this.d.contains(str2) || this.e.contains(str3) || this.f.contains(str4) || (str3.equals(str) && (ze.c() & zg.g) != 0)) ? false : true;
    }

    private static ServiceInfo b(Context context, Intent intent) {
        List<ResolveInfo> queryIntentServices = context.getPackageManager().queryIntentServices(intent, 128);
        if (queryIntentServices == null || queryIntentServices.size() == 0) {
            Log.w("ConnectionTracker", String.format("There are no handler of this intent: %s\n Stack trace: %s", new Object[]{intent.toUri(0), ze.a(3, 20)}));
            return null;
    ...
    private static int c() {
        if (h == null) {
            try {
                h = Integer.valueOf(zm.a() ? ((Integer) zf$a.a.a()).intValue() : zg.b);
            } catch (SecurityException e) {
                h = Integer.valueOf(zg.b);
            }
        }
        return h.intValue();
    }
