    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        ...
        switch (code) {
            ...
            case uu$h.com_facebook_like_view_com_facebook_horizontal_alignment /*5*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                b((aag) aag$a.zzbs(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case uu$h.CardView_cardUseCompatPadding /*6*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a((aag) aag$a.zzbs(data.readStrongBinder()), adz$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case uu$h.CardView_cardPreventCornerOverlap /*7*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(aag$a.zzbs(data.readStrongBinder()), data.readInt(), adz$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case uu$h.CardView_contentPaddingLeft /*9*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                afb a2 = a(data.readInt() != 0 ? PolylineOptions.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a2 != null) {
                    iBinder = a2.asBinder();
                }
            ...
            case uu$h.CardView_contentPaddingRight /*10*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                afh a3 = a(data.readInt() != 0 ? PolygonOptions.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a3 != null) {
                    iBinder = a3.asBinder();
                }
            ...
            case uu$h.CardView_contentPaddingTop /*11*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                afg a4 = a(data.readInt() != 0 ? MarkerOptions.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a4 != null) {
                    iBinder = a4.asBinder();
                }
            ...
            case uu$h.CardView_contentPaddingBottom /*12*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                afe a5 = a(data.readInt() != 0 ? GroundOverlayOptions.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a5 != null) {
                    iBinder = a5.asBinder();
                }
            ...
            case ha$a.Toolbar_titleMarginStart /*13*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                afi a6 = a(data.readInt() != 0 ? TileOverlayOptions.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a6 != null) {
                    iBinder = a6.asBinder();
                }
            ...
            case ha$a.Toolbar_subtitleTextColor /*24*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(adk$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case ha$a.AppCompatTheme_actionModeSelectAllDrawable /*35*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                afd a7 = a(data.readInt() != 0 ? CircleOptions.CREATOR.a(data) : null);
                reply.writeNoException();
                if (a7 != null) {
                    iBinder = a7.asBinder();
                }
            ...
            case ha$a.AppCompatTheme_actionModeShareDrawable /*36*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(aeq$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case ha$a.AppCompatTheme_actionModeWebSearchDrawable /*38*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(adw$a.a(data.readStrongBinder()), (aag) aag$a.zzbs(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case ha$a.AppCompatTheme_panelMenuListTheme /*80*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(aer$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case ha$a.AppCompatTheme_colorControlNormal /*85*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(aes$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            ...
            case ha$a.AppCompatTheme_colorControlHighlight /*87*/:
                data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                a(aet$a.a(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case 1598968902:
