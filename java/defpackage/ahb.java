...
public class ahb extends agd {
    ...
    protected void e() {
        ...
        } else if (aac.GOOGLE_PLAY_STORE_PACKAGE.equals(installerPackageName)) {
            ...
            try {
                if (!E()) {
                    ...
                    if (packageInfo2.signatures != null && packageInfo2.signatures.length > 0) {
                        this.g = ago.c(h.digest(packageInfo2.signatures[0].toByteArray()));
                    }
                }
            } catch (NameNotFoundException e2) {
                w().f().a("Package name not found", e2);
        ...
        Status a = y().O() ? abh.a(q(), "-", true) : abh.a(q());
