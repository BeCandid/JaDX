...
final class alp$b implements IInterface {
    private final IBinder a;

    public alp$b(IBinder binder) {
        this.a = binder;
    }
    ...
    public String a() throws RemoteException {
        ...
        try {
            ...
            akx.h().a("Fabric", "Could not get parcel from Google Play Service to capture AdvertisingId");
        } finally {
            reply.recycle();
            data.recycle();
        }
    ...
    L_0x002e:
        r1 = move-exception;
        r4 = defpackage.akx.h();	 Catch:{ all -> 0x0041 }
        r5 = "Fabric";
    ...
    L_0x0041:
        ...
        throw r4;
        */
        throw new UnsupportedOperationException("Method not decompiled: alp$b.b():boolean");
    }
}
