...
public final class aas {
    ...
    private aas(byte[] bArr, int i, int i2) {
        this.a = bArr;
        this.b = i;
        this.c = i + i2;
        this.e = i;
    ...
    public static aas a(byte[] bArr) {
        return aas.a(bArr, 0, bArr.length);
    }

    public static aas a(byte[] bArr, int i, int i2) {
        return new aas(bArr, i, i2);
    }
    ...
    public void a(aau aau) throws IOException {
        int j = j();
        if (this.h >= this.i) {
            throw zzami.g();
        }
    ...
    public String i() throws IOException {
        ...
        if (j < 0) {
            ...
            String str = new String(this.a, this.e, j, aat.a);
            this.e = j + this.e;
            return str;
        }
    }
