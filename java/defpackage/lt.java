...
public class lt implements lr {
    ...
    private final lt$b e = new lt$b();
    private final lp<lt$a, Bitmap> f = new lp();
    private final Map<Config, NavigableMap<Integer, Integer>> g = new HashMap();

    public void a(Bitmap bitmap) {
        lt$a key = this.e.a(ri.a(bitmap), bitmap.getConfig());
        this.f.a(key, bitmap);
    ...
    public Bitmap a() {
        ...
        if (removed != null) {
            a(Integer.valueOf(ri.a(removed)), removed.getConfig());
        }
        return removed;
    }
    ...
    public String b(int width, int height, Config config) {
        return lt.b(ri.a(width, height, config), config);
    }
    ...
    private static Config[] b(Config requested) {
        switch (lt$1.a[requested.ordinal()]) {
