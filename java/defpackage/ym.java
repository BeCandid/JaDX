...
public final class ym {
    ...
    public static String b(Context context, int i) {
        return i == 6 ? context.getResources().getString(R.string.common_google_play_services_resolution_required_title) : ym.a(context, i);
    }

    public static String b(Context context, int i, String str) {
        return i == 6 ? context.getResources().getString(R.string.common_google_play_services_resolution_required_text) : ym.a(context, i, str);
    }
