...
public class acx$a extends acz$a {
    public acx$a(int mode) {
        super("com.google.android.gms.location.places.ui.AUTOCOMPLETE");
        this.a.putExtra("gmscore_client_jar_version", xd.a);
        this.a.putExtra("mode", mode);
        this.a.putExtra("origin", 2);
    }

    public acx$a a(int i) {
        this.a.putExtra("origin", i);
        return this;
    }

    public acx$a a(AutocompleteFilter filter) {
        if (filter != null) {
    ...
    public acx$a a(LatLngBounds bounds) {
        if (bounds != null) {
