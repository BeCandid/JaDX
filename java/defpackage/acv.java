...
public class acv implements Creator<PlaceImpl> {
    public static void a(PlaceImpl placeImpl, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, placeImpl.b(), false);
        xw.a(parcel, 2, placeImpl.r(), false);
        xw.a(parcel, 3, placeImpl.t(), i, false);
        xw.a(parcel, 4, placeImpl.g(), i, false);
        xw.a(parcel, 5, placeImpl.h());
        xw.a(parcel, 6, placeImpl.i(), i, false);
        xw.a(parcel, 7, placeImpl.s(), false);
        xw.a(parcel, 8, placeImpl.j(), i, false);
        xw.a(parcel, 9, placeImpl.n());
        xw.a(parcel, 10, placeImpl.o());
        xw.a(parcel, 11, placeImpl.p());
        xw.a(parcel, 12, placeImpl.q());
        xw.a(parcel, 13, placeImpl.d(), false);
        xw.a(parcel, 14, placeImpl.f(), false);
        xw.a(parcel, 15, placeImpl.k(), false);
        xw.b(parcel, 17, placeImpl.m(), false);
        xw.a(parcel, 16, placeImpl.l(), false);
        xw.a(parcel, 1000, placeImpl.a);
        xw.a(parcel, 19, placeImpl.e(), false);
        xw.a(parcel, 20, placeImpl.c(), false);
        xw.zzI(parcel, zzav);
    }
