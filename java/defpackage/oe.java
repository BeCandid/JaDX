...
public final class oe {
    public static Bitmap a(Bitmap recycled, Bitmap toCrop, int width, int height) {
        ...
        if (recycled != null) {
            ...
            result = Bitmap.createBitmap(width, height, oe.a(toCrop));
        }
        oe.a(toCrop, result);
    ...
    public static Bitmap a(Bitmap toFit, ln pool, int width, int height) {
    ...
    public static Bitmap a(Bitmap toOrient, ln pool, int exifOrientation) {
        Matrix matrix = new Matrix();
        oe.a(exifOrientation, matrix);
