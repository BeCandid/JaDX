...
public abstract class yt$a extends Binder implements yt {
    public static yt a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IAccountAccessor");
        return (queryLocalInterface == null || !(queryLocalInterface instanceof yt)) ? new yt$a$a(iBinder) : (yt) queryLocalInterface;
    }
