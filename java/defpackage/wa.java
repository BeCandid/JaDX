...
public abstract class wa implements ServiceConnection {
    ...
    public wa(Context context, int requestMessage, int replyMessage, int protocolVersion, String applicationId) {
        ...
        this.b = new wa$1(this);
    }

    public void a(wa$a listener) {
        this.c = listener;
    }

    public boolean a() {
        if (this.d || vz.b(this.i) == -1) {
            return false;
        }
        Intent intent = vz.a(this.a);
        if (intent == null) {
            return false;
        }
        this.d = true;
