...
public abstract class aeq$a extends Binder implements aeq {
    public static aeq a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof aeq)) ? new aeq$a$a(iBinder) : (aeq) queryLocalInterface;
    }
