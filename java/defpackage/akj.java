...
public final class akj {
    public static <T extends aki> String a(T message) {
        String str;
        String valueOf;
        if (message == null) {
            return "";
        ...
        try {
            akj.a(null, message, new StringBuffer(), buf);
            return buf.toString();
    ...
    private static void a(String identifier, Object object, StringBuffer indentBuf, StringBuffer buf) throws IllegalAccessException, InvocationTargetException {
        if (object != null) {
            if (object instanceof aki) {
                int origIndentBufLength = indentBuf.length();
                if (identifier != null) {
                    buf.append(indentBuf).append(akj.a(identifier)).append(" <\n");
                    indentBuf.append("  ");
                }
                        ...
                        try {
                            ...
                            if (((Boolean) clazz.getMethod(valueOf, new Class[0]).invoke(object, new Object[0])).booleanValue()) {
                                try {
                                    ...
                                    akj.a(subfieldName, clazz.getMethod(valueOf, new Class[0]).invoke(object, new Object[0]), indentBuf, buf);
            ...
            if (object instanceof String) {
                buf.append("\"").append(akj.b((String) object)).append("\"");
            } else if (object instanceof byte[]) {
                akj.a((byte[]) object, buf);
            } else {
                buf.append(object);
            }
            buf.append("\n");
