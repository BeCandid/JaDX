...
public class alr {
    ...
    protected String b(Context context) {
        ...
        try {
            ...
            if (bundle != null) {
                ...
                if (apiKey == null) {
                    akx.h().a("Fabric", "Falling back to Crashlytics key lookup from Manifest");
                    apiKey = bundle.getString("com.crashlytics.ApiKey");
                }
            }
        } catch (Exception e) {
            akx.h().a("Fabric", "Caught non-fatal exception while retrieving apiKey: " + e);
        }
        return apiKey;
    }
    ...
    protected String c(Context context) {
        ...
        if (id == 0) {
            akx.h().a("Fabric", "Falling back to Crashlytics key lookup from Strings");
    ...
    protected void d(Context context) {
        if (akx.i() || CommonUtils.i(context)) {
