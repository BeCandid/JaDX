...
public class aac {
    ...
    @Deprecated
    public static final int GOOGLE_PLAY_SERVICES_VERSION_CODE = aac.zzqZ();
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            if (!zq.a(context)) {
                try {
                    if (a.a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 8256), aab$d.a) == null) {
                        Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                        return 9;
                    }
                    if (a.a(packageInfo, a.a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 8256), aab$d.a)) == null) {
            ...
            } else if (a.a(packageInfo, aab$d.a) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
            if (zs.a(packageInfo.versionCode) < zs.a(GOOGLE_PLAY_SERVICES_VERSION_CODE)) {
    ...
    public static void zzaa(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int a = aaa.b().a(context);
        if (a != 0) {
            Intent a2 = aaa.b().a(context, a, "e");
    ...
    public static boolean zzal(Context context) {
        return aac.zzak(context) || !aac.zzra();
    }
    ...
    public static String zzam(Context context) {
        ...
        try {
            a = abv.b(context).a(context.getPackageName(), (int) GOOGLE_PLAY_SERVICES_VERSION_CODE);
        } catch (NameNotFoundException e) {
            a = null;
        }
    ...
    private static void zzap(android.content.Context r7) {
        ...
        r0 = defpackage.abv.b(r7);	 Catch:{ NameNotFoundException -> 0x003a }
        r1 = defpackage.zb.b(r7);	 Catch:{ NameNotFoundException -> 0x003a }
    ...
    L_0x001b:
        r1 = defpackage.aad.a(r7);	 Catch:{ NameNotFoundException -> 0x003a }
        r2 = 1;
        r2 = new defpackage.aab$a[r2];	 Catch:{ NameNotFoundException -> 0x003a }
        r3 = 0;
        r4 = defpackage.aab$d.a;	 Catch:{ NameNotFoundException -> 0x003a }
        r5 = 1;
    ...
    L_0x0045:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: aac.zzap(android.content.Context):void");
    }

    @Deprecated
    public static Intent zzbC(int i) {
        return aaa.b().a(null, i, null);
    }
    ...
    public static boolean zzc(Context context, int i) {
        return i == 18 ? true : i == 1 ? aac.zzk(context, GOOGLE_PLAY_SERVICES_PACKAGE) : false;
    }

    @Deprecated
    public static boolean zzd(Context context, int i) {
        return i == 9 ? aac.zzk(context, GOOGLE_PLAY_STORE_PACKAGE) : false;
    }

    @Deprecated
    public static boolean zze(Context context, int i) {
        return zw.a(context, i);
    }
