...
public final class arw<E> extends asb<E> {
    public arw(int capacity) {
        super(capacity);
    }
    ...
    private long a() {
        return asd.a.getLongVolatile(this, f);
    }

    private long b() {
        return asd.a.getLongVolatile(this, e);
    }
}
