...
class kb implements Closeable {
    ...
    public kb(InputStream in, Charset charset) {
        this(in, 8192, charset);
    }

    public kb(InputStream in, int capacity, Charset charset) {
        if (in == null || charset == null) {
            throw new NullPointerException();
        } else if (capacity < 0) {
            throw new IllegalArgumentException("capacity <= 0");
        } else if (charset.equals(kc.a)) {
            this.a = in;
            this.b = charset;
    ...
    public String a() throws IOException {
        ...
        synchronized (this.a) {
            ...
            ByteArrayOutputStream out = new kb$1(this, (this.e - this.d) + 80);
            loop1:
            while (true) {
