...
abstract class vz$c {
    private static final HashSet<String> a = vz$c.c();
    ...
    public boolean a(Context context, String packageName) {
        ...
        try {
            for (Signature signature : context.getPackageManager().getPackageInfo(packageName, 64).signatures) {
                if (a.contains(we.a(signature.toByteArray()))) {
                    return true;
                }
            }
            return false;
    ...
    L_0x0007:
        r0 = defpackage.vz.b(r1);	 Catch:{ all -> 0x000f }
    ...
    L_0x000f:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: vz$c.a(boolean):void");
    }
}
