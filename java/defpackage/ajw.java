...
public class ajw implements Closeable, Flushable {
    ...
    private ajw a(int empty, String openBracket) throws IOException {
        m();
        a(empty);
    ...
    private ajw a(int empty, int nonempty, String closeBracket) throws IOException {
        int context = a();
