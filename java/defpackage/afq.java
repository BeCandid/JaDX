...
public class afq implements Creator<PointOfInterest> {
    public static void a(PointOfInterest pointOfInterest, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, pointOfInterest.a());
        xw.a(parcel, 2, pointOfInterest.a, i, false);
        xw.a(parcel, 3, pointOfInterest.b, false);
        xw.a(parcel, 4, pointOfInterest.c, false);
        xw.zzI(parcel, zzav);
    }
