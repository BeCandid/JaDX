...
public class afw implements Creator<StreetViewPanoramaOrientation> {
    public static void a(StreetViewPanoramaOrientation streetViewPanoramaOrientation, Parcel parcel, int i) {
        ...
        xw.a(parcel, 1, streetViewPanoramaOrientation.a());
        xw.a(parcel, 2, streetViewPanoramaOrientation.a);
        xw.a(parcel, 3, streetViewPanoramaOrientation.b);
        xw.zzI(parcel, zzav);
    }
