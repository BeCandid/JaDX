...
public abstract class adm$a extends Binder implements adm {
    public static adm a(IBinder iBinder) {
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof adm)) ? new adm$a$a(iBinder) : (adm) queryLocalInterface;
    }
