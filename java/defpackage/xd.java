...
public class xd extends aaa {
    public static final int a = aaa.b;
    ...
    public zzol a(Context context, a aVar) {
        ...
        if (a(context, aac.GOOGLE_PLAY_SERVICES_PACKAGE)) {
    ...
    public boolean a(Activity activity, abj abj, int i, int i2, OnCancelListener onCancelListener) {
        Dialog zza = GooglePlayServicesUtil.zza(i, activity, yn.a(abj, a((Context) activity, i, "d"), i2), onCancelListener);
        if (zza == null) {
            return false;
        }
