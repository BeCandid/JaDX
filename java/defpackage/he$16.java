...
class he$16 implements OnClickListener {
    ...
    public void onClick(View v) {
        if (this.a.messaging_blocked != null) {
            ...
            new Builder(this.b.f).setTitle("Message User?").setMessage("Would you like to send this user a message?").setNegativeButton(this.b.f.getResources().getString(2131230890), null).setPositiveButton(this.b.f.getResources().getString(2131230953), new he$16$1(this)).create().show();
