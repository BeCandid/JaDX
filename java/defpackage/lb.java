...
public class lb<A, T, Z> {
    private static final lb$b a = new lb$b();
    private final lf b;
    private final int c;
    private final int d;
    ...
    private final lb$a i;
    private final DiskCacheStrategy j;
    private final Priority k;
    private final lb$b l;
    private volatile boolean m;

    private defpackage.lj<T> a(defpackage.kn r6) throws java.io.IOException {
...
*/
    ...
    L_0x0035:
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: lb.a(kn):lj<T>");
    }

    public lb(lf resultKey, int width, int height, ku<A> fetcher, py<A, T> loadProvider, kr<T> transformation, pf<T, Z> transcoder, lb$a diskCacheProvider, DiskCacheStrategy diskCacheStrategy, Priority priority) {
    ...
    lb(lf resultKey, int width, int height, ku<A> fetcher, py<A, T> loadProvider, kr<T> transformation, pf<T, Z> transcoder, lb$a diskCacheProvider, DiskCacheStrategy diskCacheStrategy, Priority priority, lb$b fileOpener) {
        this.b = resultKey;
        this.c = width;
        this.d = height;
        this.e = fetcher;
    ...
    public lj<Z> a() throws Exception {
        ...
        long startTime = re.a();
        lj<T> transformed = a(this.b);
        if (Log.isLoggable("DecodeJob", 2)) {
            a("Decoded transformed from cache", startTime);
        }
        startTime = re.a();
        lj<Z> result = d(transformed);
        if (!Log.isLoggable("DecodeJob", 2)) {
            return result;
        }
    ...
    private lj<Z> a(lj<T> decoded) {
        long startTime = re.a();
        lj transformed = c(decoded);
        if (Log.isLoggable("DecodeJob", 2)) {
    ...
    private void b(lj<T> transformed) {
        if (transformed != null && this.j.b()) {
            long startTime = re.a();
            this.i.a().a(this.b, new lb$c(this, this.f.d(), transformed));
            if (Log.isLoggable("DecodeJob", 2)) {
    ...
    private lj<T> a(A data) throws IOException {
        if (this.j.a()) {
            return b((Object) data);
        }
        long startTime = re.a();
        lj<T> decoded = this.f.b().a(data, this.c, this.d);
        if (!Log.isLoggable("DecodeJob", 2)) {
            return decoded;
        }
    ...
    private lj<T> b(A data) throws IOException {
        long startTime = re.a();
        this.i.a().a(this.b.a(), new lb$c(this, this.f.c(), data));
        if (Log.isLoggable("DecodeJob", 2)) {
            a("Wrote source to cache", startTime);
        }
        startTime = re.a();
        lj<T> result = a(this.b.a());
    ...
    private lj<T> c(lj<T> decoded) {
        if (decoded == null) {
            return null;
        }
        lj<T> transformed = this.g.a(decoded, this.c, this.d);
    ...
    private lj<Z> d(lj<T> transformed) {
        if (transformed == null) {
            return null;
        }
    ...
    private void a(String message, long startTime) {
        Log.v("DecodeJob", message + " in " + re.a(startTime) + ", key: " + this.b);
    }
}
