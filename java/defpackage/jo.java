...
public class jo {
    ...
    public static Map<String, jo$c> c;
    private static final String d = null;
    private static jo$b e = null;

    public static void a(View root, Object delegate) {
        jo$a info;
        if (root.getTag() == null || !(root.getTag() instanceof jo$a)) {
            info = new jo$a();
            root.setTag(info);
        } else {
            info = (jo$a) root.getTag();
        }
        info.b = delegate;
    }

    public static View a(Context context, String xml, ViewGroup parent) {
        return jo.a(context, new ByteArrayInputStream(xml.getBytes()), parent);
    }
    ...
    public static View a(Context context, InputStream inputStream, ViewGroup parent) {
        try {
            ...
            View a = jo.a(context, dbf.newDocumentBuilder().parse(inputStream).getDocumentElement(), parent);
            inputStream.close();
            return a;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static View a(Context context, Node node, ViewGroup parent) {
        View mainView = jo.a(context, node.getNodeName());
        if (parent != null) {
            parent.addView(mainView);
        }
        jo.a(mainView, jo.a(node), parent);
        if ((mainView instanceof ViewGroup) && node.hasChildNodes()) {
            jo.b(context, node, (ViewGroup) mainView);
        }
        return mainView;
    }
    ...
    private static void b(Context context, Node node, ViewGroup mainView) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (currentNode.getNodeType() == (short) 1) {
                jo.a(context, currentNode, mainView);
            }
        }
    }
    ...
    L_0x009c:
        ...
        r36 = defpackage.jo.b(r36);
        r0 = r42;
        r1 = r36;
        r5 = defpackage.jo.a(r0, r1);
        r36 = r20;
    ...
    L_0x02ae:
        r36 = r13.getValue();
        r36 = (java.lang.String) r36;
        r18 = defpackage.jo.b(r36);
        if (r42 == 0) goto L_0x008a;
    L_0x02ba:
        r19 = defpackage.jo.a(r42);
        r27 = b;
        r36 = r27 + 1;
        b = r36;
        r0 = r40;
    ...
    L_0x02f4:
        ...
        r2 = r42;
        r3 = r39;
        r36 = defpackage.jn.a(r0, r1, r2, r3);
        r0 = r36;
        r1 = r20;
        r1.width = r0;
        goto L_0x008a;
    ...
    L_0x0498:
        ...
        r2 = r42;
        r3 = r39;
        r24 = defpackage.jn.a(r0, r1, r2, r3);
        goto L_0x008a;
    L_0x04b6:
        r36 = r13.getValue();
        r36 = (java.lang.String) r36;
        ...
        r2 = r42;
        r3 = r39;
        r26 = defpackage.jn.a(r0, r1, r2, r3);
        goto L_0x008a;
    L_0x04d4:
        r36 = r13.getValue();
        r36 = (java.lang.String) r36;
        ...
        r2 = r42;
        r3 = r39;
        r25 = defpackage.jn.a(r0, r1, r2, r3);
        goto L_0x008a;
    L_0x04f2:
        r36 = r13.getValue();
        r36 = (java.lang.String) r36;
        ...
        r2 = r42;
        r3 = r39;
        r23 = defpackage.jn.a(r0, r1, r2, r3);
        goto L_0x008a;
    L_0x0510:
        r36 = r13.getValue();
        r36 = (java.lang.String) r36;
    ...
    L_0x08ea:
        r0 = r40;
        r36 = defpackage.jo.b(r0, r8);
        r0 = r40;
        r1 = r36;
        r0.setBackgroundColor(r1);
        goto L_0x05e0;
        */
        throw new UnsupportedOperationException("Method not decompiled: jo.a(android.view.View, java.util.Map, android.view.ViewGroup):void");
    }

    private static jo$a a(View parent) {
        if (parent.getTag() != null && (parent.getTag() instanceof jo$a)) {
            return (jo$a) parent.getTag();
        }
        jo$a info = new jo$a();
        parent.setTag(info);
        return info;
    ...
    private static OnClickListener b(ViewGroup myParent, String methodName) {
        return new jo$1(myParent, methodName);
    }
    ...
    public static int a(View view, String id) {
        ...
        if (!(view.getTag() instanceof jo$a)) {
            return 0;
        }
        jo$a info = (jo$a) view.getTag();
        if (info.a.containsKey(id)) {
            return ((Integer) info.a.get(id)).intValue();
        }
        ViewGroup grp = (ViewGroup) view;
        for (int i = 0; i < grp.getChildCount(); i++) {
            int val = jo.a(grp.getChildAt(i), id);
            if (val != 0) {
                return val;
            }
        }
    ...
    public static void a() {
        c = new HashMap(30);
        c.put("scaleType", new jo$12());
        c.put("orientation", new jo$15());
        c.put("text", new jo$16());
        c.put("textSize", new jo$17());
        c.put("textColor", new jo$18());
        c.put("textStyle", new jo$19());
        c.put("textAlignment", new jo$20());
        c.put("ellipsize", new jo$21());
        c.put("singleLine", new jo$2());
        c.put("hint", new jo$3());
        c.put("inputType", new jo$4());
        c.put("gravity", new jo$5());
        c.put("src", new jo$6());
        c.put("visibility", new jo$7());
        c.put("alpha", new jo$8());
        c.put("textAllCaps", new jo$9());
        c.put("clickable", new jo$10());
        c.put("tag", new jo$11());
        c.put("onClick", new jo$13());
        c.put("elevation", new jo$14());
    }
}
