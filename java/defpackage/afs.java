...
public class afs implements Creator<PolylineOptions> {
    public static void a(PolylineOptions polylineOptions, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, polylineOptions.a());
        xw.c(parcel, 2, polylineOptions.b(), false);
        xw.a(parcel, 3, polylineOptions.c());
        xw.a(parcel, 4, polylineOptions.d());
        xw.a(parcel, 5, polylineOptions.e());
        xw.a(parcel, 6, polylineOptions.f());
        xw.a(parcel, 7, polylineOptions.g());
        xw.a(parcel, 8, polylineOptions.h());
        xw.zzI(parcel, zzav);
    }
