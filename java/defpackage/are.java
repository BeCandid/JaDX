...
public final class are<T> implements Queue<T> {
    static final int a = Integer.getInteger("jctools.spsc.max.lookahead.step", 4096).intValue();
    static final AtomicLongFieldUpdater<are> c = AtomicLongFieldUpdater.newUpdater(are.class, "b");
    static final AtomicLongFieldUpdater<are> k = AtomicLongFieldUpdater.newUpdater(are.class, "j");
    ...
    public are(int bufferSize) {
        int p2capacity = arn.a(Math.max(8, bufferSize));
    ...
    public final boolean offer(T e) {
        ...
        long index = c();
        int mask = this.f;
        int offset = are.a(index, mask);
        if (index < this.e) {
            return a(buffer, e, index, offset);
        }
        int lookAheadStep = this.d;
        if (are.a(buffer, are.a(((long) lookAheadStep) + index, mask)) == null) {
            this.e = (((long) lookAheadStep) + index) - 1;
            return a(buffer, e, index, offset);
        } else if (are.a(buffer, are.a(1 + index, mask)) != null) {
            return a(buffer, e, index, offset);
        } else {
    ...
    private boolean a(AtomicReferenceArray<Object> buffer, T e, long index, int offset) {
        a(1 + index);
        are.a((AtomicReferenceArray) buffer, offset, (Object) e);
        return true;
    }
    ...
    private void a(AtomicReferenceArray<Object> oldBuffer, long currIndex, int offset, T e, long mask) {
        ...
        a(currIndex + 1);
        are.a(newBuffer, offset, (Object) e);
        a((AtomicReferenceArray) oldBuffer, newBuffer);
        are.a((AtomicReferenceArray) oldBuffer, offset, l);
    }

    private void a(AtomicReferenceArray<Object> curr, AtomicReferenceArray<Object> next) {
        are.a((AtomicReferenceArray) curr, are.b(curr.length() - 1), (Object) next);
    }

    private AtomicReferenceArray<Object> a(AtomicReferenceArray<Object> curr) {
        return (AtomicReferenceArray) are.a((AtomicReferenceArray) curr, are.b(curr.length() - 1));
    }
    ...
    private T a(AtomicReferenceArray<Object> nextBuffer, long index, int mask) {
        this.i = nextBuffer;
        int offsetInNew = are.a(index, mask);
        T n = are.a((AtomicReferenceArray) nextBuffer, offsetInNew);
        if (n == null) {
            return null;
        }
        b(1 + index);
        are.a((AtomicReferenceArray) nextBuffer, offsetInNew, null);
        return n;
    }
    ...
    public final T peek() {
        ...
        long index = d();
        int mask = this.h;
        Object e = are.a(buffer, are.a(index, mask));
        if (e == l) {
    ...
    private T b(AtomicReferenceArray<Object> nextBuffer, long index, int mask) {
        this.i = nextBuffer;
        return are.a((AtomicReferenceArray) nextBuffer, are.a(index, mask));
    }
