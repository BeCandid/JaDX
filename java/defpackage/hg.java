...
public class hg extends ArrayAdapter<Group> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            row = ((Activity) getContext()).getLayoutInflater().inflate(2130968690, parent, false);
            row.findViewById(2131624502).setVisibility(8);
            row.findViewById(2131624504).setVisibility(8);
        }
        ((TextView) row.findViewById(2131624503)).setText(((Group) getItem(position)).group_name);
        row.findViewById(2131624501).setVisibility(8);
        return row;
    }
