...
public final class ajk extends ajv {
    private static final Reader b = new ajk$1();
    private static final Object c = new Object();
    private final List<Object> d = new ArrayList();

    public ajk(ail element) {
        super(b);
        this.d.add(element);
    }
    ...
    public JsonToken f() throws IOException {
        ...
        if (o instanceof Iterator) {
            boolean isObject = this.d.get(this.d.size() - 2) instanceof ain;
            Iterator<?> iterator = o;
            if (!iterator.hasNext()) {
    ...
    public void o() throws IOException {
        ...
        Entry<?, ?> entry = (Entry) ((Iterator) u()).next();
        this.d.add(entry.getValue());
        this.d.add(new aip((String) entry.getKey()));
    }
}
