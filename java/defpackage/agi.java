...
public class agi extends agd {
    private Handler a;
    private long b;
    private final Runnable c = new agi$1(this);
    private final agt d = new agi$2(this, this.n);
    private final agt e = new agi$3(this, this.n);
    ...
    protected void f() {
        ...
        v().a(new agi$4(this, p().b()));
    }

    protected void g() {
        v().a(new agi$5(this, p().b()));
    }
