...
public class afy implements Creator<TileOverlayOptions> {
    public static void a(TileOverlayOptions tileOverlayOptions, Parcel parcel, int i) {
        int zzav = xw.zzav(parcel);
        xw.a(parcel, 1, tileOverlayOptions.a());
        xw.a(parcel, 2, tileOverlayOptions.b(), false);
        xw.a(parcel, 3, tileOverlayOptions.d());
        xw.a(parcel, 4, tileOverlayOptions.c());
        xw.a(parcel, 5, tileOverlayOptions.e());
        xw.zzI(parcel, zzav);
    }
