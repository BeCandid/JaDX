...
public class aho implements Creator<CheckServerAuthResult> {
    public static void a(CheckServerAuthResult checkServerAuthResult, Parcel parcel, int i) {
        int a = xw.a(parcel);
        xw.a(parcel, 1, checkServerAuthResult.a);
        xw.a(parcel, 2, checkServerAuthResult.b);
        xw.c(parcel, 3, checkServerAuthResult.c, false);
        xw.a(parcel, a);
    }
