...
public class agy implements Creator<EventParcel> {
    public static void a(EventParcel eventParcel, Parcel parcel, int i) {
        int a = xw.a(parcel);
        xw.a(parcel, 1, eventParcel.a);
        xw.a(parcel, 2, eventParcel.b, false);
        xw.a(parcel, 3, eventParcel.c, i, false);
        xw.a(parcel, 4, eventParcel.d, false);
        xw.a(parcel, 5, eventParcel.e);
        xw.a(parcel, a);
    }
