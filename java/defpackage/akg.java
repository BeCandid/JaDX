...
public final class akg {
    ...
    public static akg a(byte[] buf) {
        return akg.a(buf, 0, buf.length);
    }

    public static akg a(byte[] buf, int off, int len) {
        return new akg(buf, off, len);
    }
    ...
    public void a(aki msg) throws IOException {
        int length = f();
        if (this.h >= this.i) {
    ...
    private akg(byte[] buffer, int off, int len) {
        this.a = buffer;
        this.b = off;
        this.c = off + len;
        this.e = off;
