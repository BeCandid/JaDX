...
public class vg {
    ...
    public static defpackage.vg a(android.content.Context r16) {
...
*/
    ...
    L_0x0042:
        r11 = defpackage.vg.e(r16);	 Catch:{ Exception -> 0x00c4, all -> 0x00e9 }
    ...
    L_0x004c:
        r0 = defpackage.vg.a(r10);	 Catch:{ Exception -> 0x00c4, all -> 0x00e9 }
    ...
    L_0x00ef:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: vg.a(android.content.Context):vg");
    }

    private static vg b(Context context) {
        vg identifiers = vg.c(context);
        if (identifiers != null) {
            return identifiers;
        }
        identifiers = vg.d(context);
        if (identifiers == null) {
            return new vg();
        }
        return identifiers;
    ...
    private static vg c(Context context) {
        try {
            ...
            Method isGooglePlayServicesAvailable = we.a("com.google.android.gms.common.GooglePlayServicesUtil", "isGooglePlayServicesAvailable", Context.class);
            if (isGooglePlayServicesAvailable == null) {
                return null;
            }
            Object connectionResult = we.a(null, isGooglePlayServicesAvailable, context);
            if (!(connectionResult instanceof Integer) || ((Integer) connectionResult).intValue() != 0) {
                return null;
            }
            Method getAdvertisingIdInfo = we.a("com.google.android.gms.ads.identifier.AdvertisingIdClient", "getAdvertisingIdInfo", Context.class);
            if (getAdvertisingIdInfo == null) {
                return null;
            }
            Object advertisingInfo = we.a(null, getAdvertisingIdInfo, context);
            if (advertisingInfo == null) {
                return null;
            }
            Method getId = we.a(advertisingInfo.getClass(), "getId", new Class[0]);
            Method isLimitAdTrackingEnabled = we.a(advertisingInfo.getClass(), "isLimitAdTrackingEnabled", new Class[0]);
            if (getId == null || isLimitAdTrackingEnabled == null) {
                return null;
            }
            vg identifiers = new vg();
            identifiers.c = (String) we.a(advertisingInfo, getId, new Object[0]);
            identifiers.e = ((Boolean) we.a(advertisingInfo, isLimitAdTrackingEnabled, new Object[0])).booleanValue();
            return identifiers;
        } catch (Exception e) {
            we.a("android_id", e);
            return null;
    ...
    private static vg a(vg identifiers) {
