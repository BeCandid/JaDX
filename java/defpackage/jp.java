...
public class jp extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        triangle.lineTo((float) bounds.right, (float) bounds.top);
        triangle.lineTo((float) (bounds.left + ((bounds.right - bounds.left) / 2)), (float) bounds.bottom);
