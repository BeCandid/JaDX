...
public class wk extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(uu$e.com_facebook_login_fragment, container, false);
        this.b.a(new wk$2(this, view));
        return view;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(uu$d.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
