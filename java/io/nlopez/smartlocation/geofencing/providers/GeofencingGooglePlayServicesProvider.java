...
public class GeofencingGooglePlayServicesProvider implements xh$b, xh$c, xl<Status> {
    ...
    public static class GeofencingService extends IntentService {
        ...
        protected void onHandleIntent(Intent intent) {
            acm geofencingEvent = acm.a(intent);
            if (geofencingEvent != null && !geofencingEvent.a()) {
                ...
                for (ack geofence : geofencingEvent.c()) {
    ...
    public GeofencingGooglePlayServicesProvider(aor playServicesListener) {
            ...
            public void onReceive(Context context, Intent intent) {
                if (GeofencingGooglePlayServicesProvider.a.equals(intent.getAction()) && intent.hasExtra("geofences")) {
                    ...
                    for (String geofenceId : intent.getStringArrayListExtra("geofences")) {
                        aop geofenceModel = this.a.g.a(geofenceId);
                        if (geofenceModel != null) {
                            this.a.f.a(new aoq(geofenceModel, transitionType));
                        } else {
