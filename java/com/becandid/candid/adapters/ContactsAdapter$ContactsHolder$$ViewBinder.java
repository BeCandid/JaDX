...
public class ContactsAdapter$ContactsHolder$$ViewBinder<T extends ContactsHolder> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, T target, Object source) {
        a unbinder = a(target);
        target.contactName = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624363, "field 'contactName'"), 2131624363, "field 'contactName'");
        target.contactPhoto = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624361, "field 'contactPhoto'"), 2131624361, "field 'contactPhoto'");
        target.animalBgView = (View) finder.findRequiredView(source, 2131624360, "field 'animalBgView'");
        target.invite = (Button) finder.castView((View) finder.findRequiredView(source, 2131624362, "field 'invite'"), 2131624362, "field 'invite'");
        return unbinder;
    }
