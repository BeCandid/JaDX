...
public class ContactsAdapter extends Adapter<c> {
    ...
    public class ContactsHolder extends c implements OnClickListener {
        ...
        public void a(a contact, int position) {
            ...
            this.contactPhoto.setText(io.a(contact.a));
    ...
    public c a(ViewGroup parent, int viewType) {
        if (viewType == 2) {
            return new ContactsHolder(this, LayoutInflater.from(parent.getContext()).inflate(2130968645, parent, false));
        }
        if (viewType == 1) {
            return new LetterHolder(this, LayoutInflater.from(parent.getContext()).inflate(2130968646, parent, false));
        }
        return null;
    }
