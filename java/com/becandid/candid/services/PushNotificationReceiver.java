...
public class PushNotificationReceiver extends BroadcastReceiver {
    ...
    private void a(String notificationId, String title, String message, String url, Bundle data) {
        try {
            ...
            Builder mBuilder = new Builder(this.a).setSmallIcon(2130838020).setContentTitle(title).setPriority(1).setStyle(new BigTextStyle().bigText(message)).setAutoCancel(true).setContentText(message);
    ...
    private PendingIntent a(Bundle payload, String notificationId) {
        ...
        switch (z) {
            ...
            case uu$h.CardView_cardUseCompatPadding /*6*/:
                ...
                ain groupDetails = new aio().a(payload.getString("group")).m();
