...
import defpackage.in$af;
import defpackage.in$g;
...
public class ContentEditActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.h = new hg(this, 2130968690, new ArrayList(AppState.groups));
        ...
        this.editText.setOnFocusChangeListener(new OnFocusChangeListener(this) {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus && this.a.k == 0) {
                    jb.a(this.a.editText.getText(), this.a.editText, this.a.g, this.a.h);
                }
            }
        });
        this.editText.addTextChangedListener(new TextWatcher(this) {
            ...
            public void afterTextChanged(Editable s) {
                if (this.a.k == 0 && !s.toString().equals(this.a.i.toString())) {
                    this.a.i = s.toString();
                    jb.a((CharSequence) s, this.a.editText, this.a.g, this.a.h);
                    if (this.a.j) {
        ...
        this.editSave.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View v) {
                if (this.a.editText.getText().toString().equals("") || this.a.editText.getText().toString().trim().equals("")) {
                    Toast.makeText(this.a, 2131230816, 0).show();
                    return;
                }
                ...
                if (this.a.e.equals("comment")) {
                    ...
                    ik.a().m(params).b(Schedulers.io()).a(apv.a()).b(new apr<NetworkData>(this) {
                        ...
                        public void onNext(NetworkData networkData) {
                            if (networkData.success) {
                                ...
                                ix.a().a(new in$g(this.a.a.c, this.a.a.editText.getText().toString(), mentions));
                    ...
                    ik.a().l(params).b(Schedulers.io()).a(apv.a()).b(new apr<NetworkData>(this) {
                        final /* synthetic */ AnonymousClass5 a;
                        ...
                        public void onNext(NetworkData networkData) {
                            if (networkData.success) {
                                ...
                                ix.a().a(new in$af(this.a.a.c, this.a.a.editText.getText().toString(), mentions));
                                this.a.a.finish();
                                return;
                            }
                            this.a.a.editSpinny.setVisibility(8);
