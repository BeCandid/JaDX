...
public class CreatePostActivity$$ViewBinder<T extends CreatePostActivity> implements ViewBinder<T> {
    ...
    public Unbinder bind(final Finder finder, final T target, Object source) {
        ...
        target.postButton = (Button) finder.castView((View) finder.findRequiredView(source, 2131624130, "field 'postButton'"), 2131624130, "field 'postButton'");
        ...
        target.friendMarker = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624129, "field 'friendMarker'"), 2131624129, "field 'friendMarker'");
        target.friendSwitch = (SwitchCompat) finder.castView((View) finder.findRequiredView(source, 2131624128, "field 'friendSwitch'"), 2131624128, "field 'friendSwitch'");
        ...
        target.webSearchBtn = (View) finder.findRequiredView(source, 2131624127, "field 'webSearchBtn'");
        target.postSpinny = (View) finder.findRequiredView(source, 2131624131, "field 'postSpinny'");
