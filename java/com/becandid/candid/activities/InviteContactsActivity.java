...
public class InviteContactsActivity extends BaseActivity {
    ...
    public void inviteAll(View v) {
        new Builder(this).setTitle("Invite Contacts").setMessage("Do you want to anonymously invite your selected contacts?").setCancelable(true).setNegativeButton(getResources().getString(2131230890), new OnClickListener(this) {
    ...
    public aij getContacts() {
        List<String> animals = new ArrayList(io.a.keySet());
        aij contacts = new aij();
    ...
    public void sendContactsToServer() {
        ik.a().a(this.e, getIntent().getStringExtra("upsell_id"), this.sendInviteName).b(Schedulers.io()).a(apv.a()).b(new apr<EmptyClass>(this) {
            final /* synthetic */ InviteContactsActivity a;
            ...
            public void onCompleted() {
                if (this.a.c != -1 || this.a.d != 0) {
                    ik.a().e(this.a.c).b(Schedulers.io()).a(apv.a()).b(new EmptySubscriber());
