...
public class GroupTagsFragment extends Fragment implements a {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(2130968672, container, false);
        ...
        if (this.b.containsKey("tags")) {
            ...
            this.c.addAll(tags);
            jb.a(getActivity(), this.mTagsView, AppState.groupTags);
    ...
    public void a() {
        final CreateGroupActivity activity = (CreateGroupActivity) getActivity();
        ik.a().a(((Integer) this.b.get("group_id")).intValue(), activity.getmGroupName(), activity.getmGroupAbout(), activity.getGroupTags(), activity.getmGroupSourceUrl()).b(Schedulers.io()).a(apv.a()).b(new apr<Group>(this) {
            final /* synthetic */ GroupTagsFragment b;
    ...
    public void b() {
        final CreateGroupActivity activity = (CreateGroupActivity) getActivity();
        ik.a().a(activity.getmGroupName(), activity.getmGroupAbout(), activity.getGroupTags(), activity.getmGroupSourceUrl()).b(Schedulers.io()).a(apv.a()).b(new apr<Group>(this) {
            final /* synthetic */ GroupTagsFragment b;
