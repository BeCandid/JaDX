...
public class OnboardingVerifyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(2130968728, container, false);
    ...
    private void c() {
        this.verifyHeader.setText(AppState.config.getString("code_header", getString(2131230945)));
        this.verifySubheader.setText(AppState.config.getString("code_subheader", getString(2131230948)));
        this.verify.setHint(AppState.config.getString("code_input", getString(2131230946)));
        this.resend.setText(AppState.config.getString("resend_code_button", getString(2131230947)));
    }
    ...
    public void a() {
        ...
        ik.a().a(this.verify.getText().toString(), AppState.contactsInfo.phone_number).b(Schedulers.io()).a(apv.a()).b(new apr<NetworkData>(this) {
            final /* synthetic */ OnboardingVerifyFragment a;
    ...
    public void b() {
        ...
        this.submit.setClickable(false);
        this.spinny.setVisibility(0);
        ik.a().b(hashParams).b(Schedulers.io()).a(apv.a()).b(new apr<ain>(this) {
            final /* synthetic */ OnboardingVerifyFragment a;
