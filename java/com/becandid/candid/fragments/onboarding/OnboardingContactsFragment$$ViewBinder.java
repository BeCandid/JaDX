...
public class OnboardingContactsFragment$$ViewBinder<T extends OnboardingContactsFragment> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, T target, Object source) {
        a unbinder = a(target);
        target.skip = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624637, "field 'skip'"), 2131624637, "field 'skip'");
        target.contactsButton = (Button) finder.castView((View) finder.findRequiredView(source, 2131624640, "field 'contactsButton'"), 2131624640, "field 'contactsButton'");
        target.contactsSubheader = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624638, "field 'contactsSubheader'"), 2131624638, "field 'contactsSubheader'");
        target.contactsSubheader2 = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624639, "field 'contactsSubheader2'"), 2131624639, "field 'contactsSubheader2'");
