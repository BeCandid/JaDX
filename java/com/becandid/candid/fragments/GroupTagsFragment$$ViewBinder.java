...
public class GroupTagsFragment$$ViewBinder<T extends GroupTagsFragment> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, T target, Object source) {
        a unbinder = a(target);
        target.mTagsView = (RelativeLayout) finder.castView((View) finder.findRequiredView(source, 2131624440, "field 'mTagsView'"), 2131624440, "field 'mTagsView'");
        target.mCreateGroupBtn = (Button) finder.castView((View) finder.findRequiredView(source, 2131624442, "field 'mCreateGroupBtn'"), 2131624442, "field 'mCreateGroupBtn'");
        target.mProgressBar = (View) finder.findRequiredView(source, uu$d.progress_bar, "field 'mProgressBar'");
        target.mTagsPlaceholder = (View) finder.findRequiredView(source, 2131624437, "field 'mTagsPlaceholder'");
        return unbinder;
    }
