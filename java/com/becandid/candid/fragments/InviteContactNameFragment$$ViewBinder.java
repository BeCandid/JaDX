...
public class InviteContactNameFragment$$ViewBinder<T extends InviteContactNameFragment> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, T target, Object source) {
        ...
        target.mInviteName = (AppCompatEditText) finder.castView((View) finder.findRequiredView(source, 2131624459, "field 'mInviteName'"), 2131624459, "field 'mInviteName'");
        target.mSendText = (Button) finder.castView((View) finder.findRequiredView(source, 2131624460, "field 'mSendText'"), 2131624460, "field 'mSendText'");
        return unbinder;
    }
