...
public class InviteContactMethodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(2130968673, container, false);
    ...
    private void a(boolean isSelected) {
        if (isSelected) {
            this.mAnonPlaceHolder.setBackground(getResources().getDrawable(2130837981));
            this.mAnonCheckmark.setImageDrawable(getResources().getDrawable(2130837982));
            return;
        }
    ...
    private void b(boolean isSelected) {
        if (isSelected) {
            this.mKnownPlaceHolder.setBackground(getResources().getDrawable(2130837981));
            this.mKnownCheckmark.setImageDrawable(getResources().getDrawable(2130837982));
            return;
        }
