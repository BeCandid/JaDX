...
public class InviteContactMethodFragment$$ViewBinder<T extends InviteContactMethodFragment> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, final T target, Object source) {
        a unbinder = a(target);
        target.mAnonPlaceHolder = (View) finder.findRequiredView(source, 2131624449, "field 'mAnonPlaceHolder'");
        target.mKnownPlaceHolder = (View) finder.findRequiredView(source, 2131624452, "field 'mKnownPlaceHolder'");
        target.mContinueBtn = (Button) finder.castView((View) finder.findRequiredView(source, 2131624455, "field 'mContinueBtn'"), 2131624455, "field 'mContinueBtn'");
        target.mAnonCheckmark = (ImageView) finder.castView((View) finder.findRequiredView(source, 2131624450, "field 'mAnonCheckmark'"), 2131624450, "field 'mAnonCheckmark'");
        target.mKnownCheckmark = (ImageView) finder.castView((View) finder.findRequiredView(source, 2131624453, "field 'mKnownCheckmark'"), 2131624453, "field 'mKnownCheckmark'");
        View view = (View) finder.findRequiredView(source, 2131624445, "method 'onContactClose'");
        unbinder.a = view;
