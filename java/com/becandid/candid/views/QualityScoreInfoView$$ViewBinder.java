...
public class QualityScoreInfoView$$ViewBinder<T extends QualityScoreInfoView> extends BlurLayout$$ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, T target, Object source) {
        ...
        target.mScoreText = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624528, "field 'mScoreText'"), 2131624528, "field 'mScoreText'");
        ...
        target.mClosePopup = (Button) finder.castView((View) finder.findOptionalView(source, 2131624796, null), 2131624796, "field 'mClosePopup'");
        return unbinder;
    }
