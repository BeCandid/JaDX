...
public class TagBox$$ViewBinder<T extends TagBox> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, T target, Object source) {
        a unbinder = a(target);
        target.mTagIcon = (ImageView) finder.castView((View) finder.findRequiredView(source, 2131624828, "field 'mTagIcon'"), 2131624828, "field 'mTagIcon'");
        target.mTagName = (TextView) finder.castView((View) finder.findRequiredView(source, 2131624829, "field 'mTagName'"), 2131624829, "field 'mTagName'");
        return unbinder;
    }
