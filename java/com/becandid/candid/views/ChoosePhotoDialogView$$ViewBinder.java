...
public class ChoosePhotoDialogView$$ViewBinder<T extends ChoosePhotoDialogView> implements ViewBinder<T> {
    ...
    public Unbinder a(Finder finder, final T target, Object source) {
        a unbinder = a(target);
        target.spinny = (ProgressBar) finder.castView((View) finder.findRequiredView(source, 2131624318, "field 'spinny'"), 2131624318, "field 'spinny'");
        target.suggestedPhotoView = (RecyclerView) finder.castView((View) finder.findRequiredView(source, 2131624317, "field 'suggestedPhotoView'"), 2131624317, "field 'suggestedPhotoView'");
        View view = (View) finder.findRequiredView(source, 2131624319, "method 'takePhoto'");
        unbinder.a = view;
        ...
        view = (View) finder.findRequiredView(source, 2131624320, "method 'library'");
        unbinder.b = view;
        view.setOnClickListener(new DebouncingOnClickListener(this) {
            final /* synthetic */ ChoosePhotoDialogView$$ViewBinder b;
        ...
        view = (View) finder.findRequiredView(source, 2131624321, "method 'cancel'");
        unbinder.c = view;
        view.setOnClickListener(new DebouncingOnClickListener(this) {
            final /* synthetic */ ChoosePhotoDialogView$$ViewBinder b;
