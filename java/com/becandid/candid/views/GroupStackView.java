...
public class GroupStackView extends RelativeLayout implements OnClickListener, OnTouchListener {
    ...
    public class a {
        ...
        public a(GroupStackView this$0, View card) {
            ...
            this.b = (TextView) card.findViewById(2131624494);
            this.c = (TextView) card.findViewById(2131624387);
            this.d = new TextView[]{(TextView) card.findViewById(2131624383), (TextView) card.findViewById(2131624384), (TextView) card.findViewById(2131624385)};
            this.e = (ImageView) card.findViewById(2131624379);
            this.f = (TextView) card.findViewById(2131624493);
            this.g = (ImageView) card.findViewById(2131624495);
            this.h = (ImageView) card.findViewById(2131624496);
        }
    ...
    private void d() {
        if (getChildCount() <= 0) {
            ...
            bottomParams.setMargins(0, 0, 0, (int) (50.0f * this.q));
            ...
            tapCardParams.setMargins(0, 0, 0, (int) (50.0f * this.q));
            ...
            params.addRule(12);
            params.setMargins((int) (15.0f * this.q), 0, (int) (15.0f * this.q), (int) (15.0f * this.q));
            ...
            this.t.setBackground(getResources().getDrawable(2130837987));
            ...
            this.s.setBackground(getResources().getDrawable(2130838157));
    ...
    private View e() {
        View card = LayoutInflater.from(getContext()).inflate(2130968688, this.a, false);
    ...
    private void a(final View card, int target, int duration) {
        if (target > 0) {
            a((Group) card.getTag(2131624387));
        } else {
            b((Group) card.getTag(2131624387));
        }
    ...
    public void a(Group group) {
        ik.a().b(group.group_id).b(Schedulers.io()).a(apv.a()).b(new apr<NetworkData>(this) {
    ...
    public void b(final Group group) {
        ik.a().a(group).b(Schedulers.io()).a(apv.a()).b(new apr<EmptyClass>(this) {
