...
public class RoundedCornersTransformation implements kr<Bitmap> {
    private ln a;
    private int b;
    private int c;
    private int d;
    ...
    public RoundedCornersTransformation(Context context, int radius, int margin, CornerType cornerType) {
        this(jx.a(context).a(), radius, margin, cornerType);
    }

    public RoundedCornersTransformation(ln pool, int radius, int margin, CornerType cornerType) {
        this.a = pool;
        this.b = radius;
        this.c = this.b * 2;
        this.d = margin;
    ...
    public lj<Bitmap> a(lj<Bitmap> resource, int outWidth, int outHeight) {
        return a((Bitmap) resource.b(), outWidth, outHeight);
    }

    public lj<Bitmap> a(Bitmap source, int outWidth, int outHeight) {
