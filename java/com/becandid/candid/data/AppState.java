...
public class AppState {
    ...
    public static void loadState(ContextWrapper context) {
        ...
        if (sharedPref.contains("tags")) {
            try {
                Type type = new aju<List<String>>() {
                }.getType();
                tags = (List) new aih().a(sharedPref.getString("tags", "{}"), type);
            } catch (ClassCastException e) {
            }
        }
        if (sharedPref.contains("teenTags")) {
            try {
                type = new aju<List<String>>() {
                }.getType();
                teenTags = (List) new aih().a(sharedPref.getString("teenTags", "{}"), type);
        ...
        if (sharedPref.contains("adultTags")) {
            try {
                ...
                adultTags = (List) new aih().a(sharedPref.getString("adultTags", "{}"), type);
        ...
        if (sharedPref.contains("hasLinkSearched")) {
            hasLinkSearched = sharedPref.getBoolean("hasLinkSearched", false);
        }
        ...
        if (sharedPref.contains("tabsOrder")) {
            ...
            tabsOrder = (List) new aih().a(sharedPref.getString("tabsOrder", "{}"), type);
        }
