...
public class DataUtil {
    ...
    public static aih gson = new aih();
    ...
    public static Map<String, Object> toMap(ain obj) {
        return (Map) gson.a((ail) obj, new aju<Map<String, Object>>() {
        }.getType());
    }

    public static Map<String, Object> toMap(String objJson) {
        return (Map) gson.a(objJson, new aju<Map<String, Object>>() {
        }.getType());
    }

    public static <T> List<T> toList(aij array, Class<T> clazz) {
        int size = array.a();
    ...
    public static ain newJsonObject(String... args) {
        if (args.length % 2 != 0) {
            Log.e("DataUtil", "Bad ");
        }
        ain obj = new ain();
