...
public final class FacebookRequestError implements Parcelable {
    ...
    public static FacebookRequestError a(JSONObject singleResult, Object batchResult, HttpURLConnection connection) {
        try {
            if (singleResult.has("code")) {
                ...
                Object body = we.a(singleResult, "body", "FACEBOOK_NON_JSON_RESULT");
                if (body != null && (body instanceof JSONObject)) {
                    ...
                    if (jsonBody.has("error")) {
                        JSONObject error = (JSONObject) we.a(jsonBody, "error", null);
                ...
                if (!a.a(responseCode)) {
                    ...
                    if (singleResult.has("body")) {
                        jSONObject = (JSONObject) we.a(singleResult, "body", "FACEBOOK_NON_JSON_RESULT");
                    } else {
                        jSONObject = null;
                    }
    ...
    static synchronized vn h() {
        vn a;
        synchronized (FacebookRequestError.class) {
            we$b appSettings = we.d(ul.i());
            if (appSettings == null) {
                a = vn.a();
            } else {
                a = appSettings.f();
