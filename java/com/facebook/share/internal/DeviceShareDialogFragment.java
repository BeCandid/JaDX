...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        this.c = new Dialog(getActivity(), uu$g.com_facebook_auth_dialog);
        ...
        ((TextView) view.findViewById(uu$d.com_facebook_device_dialog_title)).setText(getString(uu$f.com_facebook_share_button_text));
    ...
    private Bundle b() {
        ...
        if (content instanceof ShareLinkContent) {
            return xa.a((ShareLinkContent) content);
        }
        if (content instanceof ShareOpenGraphContent) {
            return xa.a((ShareOpenGraphContent) content);
        }
        return null;
    }
