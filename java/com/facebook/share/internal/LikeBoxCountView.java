...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void a(Context context) {
        ...
        this.c = getResources().getDimension(uu$b.com_facebook_likeboxcountview_caret_height);
        this.d = getResources().getDimension(uu$b.com_facebook_likeboxcountview_caret_width);
        this.e = getResources().getDimension(uu$b.com_facebook_likeboxcountview_border_radius);
        this.f = new Paint();
        this.f.setColor(getResources().getColor(uu$a.com_facebook_likeboxcountview_border_color));
        this.f.setStrokeWidth(getResources().getDimension(uu$b.com_facebook_likeboxcountview_border_width));
    ...
    private void b(Context context) {
        ...
        this.a.setTextSize(0, getResources().getDimension(uu$b.com_facebook_likeboxcountview_text_size));
        this.a.setTextColor(getResources().getColor(uu$a.com_facebook_likeboxcountview_text_color));
        this.g = getResources().getDimensionPixelSize(uu$b.com_facebook_likeboxcountview_text_padding);
        this.h = getResources().getDimensionPixelSize(uu$b.com_facebook_likeboxcountview_caret_height);
    }
