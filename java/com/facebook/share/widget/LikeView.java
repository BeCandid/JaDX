...
import defpackage.uu$b;
import defpackage.uu$h;
import defpackage.vq;
import defpackage.vz;
import defpackage.we;
import defpackage.ws;
import defpackage.ws$c;
...
public class LikeView extends FrameLayout {
    ...
    class b extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (extras != null) {
                ...
                shouldRespond = we.a((String) broadcastObjectId) || we.a(this.a.a, broadcastObjectId);
            }
            if (!shouldRespond) {
                return;
            }
    ...
    public void setObjectIdAndType(String objectId, ObjectType objectType) {
        objectId = we.a(objectId, null);
        if (objectType == null) {
            objectType = ObjectType.d;
        }
        if (!we.a((Object) objectId, this.a) || objectType != this.b) {
    ...
    private void a(AttributeSet attrs) {
        if (attrs != null && getContext() != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, uu$h.com_facebook_like_view);
            if (a != null) {
                this.a = we.a(a.getString(uu$h.com_facebook_like_view_com_facebook_object_id), null);
                this.b = ObjectType.a(a.getInt(uu$h.com_facebook_like_view_com_facebook_object_type, ObjectType.d.a()));
                this.k = Style.a(a.getInt(uu$h.com_facebook_like_view_com_facebook_style, Style.d.a()));
                if (this.k == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'style'");
                }
                this.m = AuxiliaryViewPosition.a(a.getInt(uu$h.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.d.a()));
                if (this.m == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'auxiliary_view_position'");
                }
                this.l = HorizontalAlignment.a(a.getInt(uu$h.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.d.a()));
                if (this.l == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'horizontal_alignment'");
                }
                this.n = a.getColor(uu$h.com_facebook_like_view_com_facebook_foreground_color, -1);
                a.recycle();
            }
        }
    }
    ...
    private void a(Context context) {
        this.o = getResources().getDimensionPixelSize(uu$b.com_facebook_likeview_edge_padding);
        this.p = getResources().getDimensionPixelSize(uu$b.com_facebook_likeview_internal_padding);
        if (this.n == -1) {
            this.n = getResources().getColor(uu$a.com_facebook_likeview_text_color);
        }
    ...
    private void c(Context context) {
        ...
        this.f.setTextSize(0, getResources().getDimension(uu$b.com_facebook_likeview_text_size));
    ...
    private Bundle getAnalyticsParameters() {
        ...
        params.putString("object_id", we.a(this.a, ""));
    ...
    private void a(String newObjectId, ObjectType newObjectType) {
        ...
        if (!we.a(newObjectId)) {
            this.j = new a();
            if (!isInEditMode()) {
                ws.a(newObjectId, newObjectType, this.j);
            }
        }
    }

    private void a(ws likeActionController) {
    ...
    private void d() {
        ...
        if (this.k == Style.STANDARD && this.g != null && !we.a(this.g.c())) {
            auxView = this.f;
        } else if (this.k == Style.BOX_COUNT && this.g != null && !we.a(this.g.b())) {
            e();
            auxView = this.e;
        } else {
            return;
