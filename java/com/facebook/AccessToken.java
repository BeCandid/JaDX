...
public final class AccessToken implements Parcelable {
    ...
    public static AccessToken a(Bundle bundle) {
        ...
        String applicationId = up.d(bundle);
        if (we.a(applicationId)) {
            applicationId = ul.i();
        }
        String tokenString = up.b(bundle);
        try {
            return new AccessToken(tokenString, applicationId, we.e(tokenString).getString("id"), permissions, declinedPermissions, up.c(bundle), up.a(bundle, "com.facebook.TokenCachingStrategy.ExpirationDate"), up.a(bundle, "com.facebook.TokenCachingStrategy.LastRefreshDate"));
    ...
    public static AccessToken a(JSONObject jsonObject) throws JSONException {
        ...
        return new AccessToken(token, jsonObject.getString("application_id"), jsonObject.getString("user_id"), we.a(permissionsArray), we.a(declinedPermissionsArray), AccessTokenSource.valueOf(jsonObject.getString("source")), expiresAt, lastRefresh);
    }
