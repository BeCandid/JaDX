...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.c = (DeviceAuthMethodHandler) ((wk) ((FacebookActivity) getActivity()).a()).b().g();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        this.h = new Dialog(getActivity(), uu$g.com_facebook_auth_dialog);
        View view = getActivity().getLayoutInflater().inflate(uu$e.com_facebook_device_auth_dialog_fragment, null);
        this.a = (ProgressBar) view.findViewById(uu$d.progress_bar);
        this.b = (TextView) view.findViewById(uu$d.confirmation_code);
        ((Button) view.findViewById(uu$d.cancel_button)).setOnClickListener(new OnClickListener(this) {
        ...
        ((TextView) view.findViewById(uu$d.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(uu$f.com_facebook_device_auth_instructions)));
    ...
    public void a(Request request) {
        ...
        parameters.putString("access_token", wf.b() + "|" + wf.c());
    ...
    private void a(final String accessToken) {
        ...
        new GraphRequest(new AccessToken(accessToken, ul.i(), "0", null, null, null, null, null), "me", parameters, HttpMethod.GET, new b(this) {
            ...
            public void onCompleted(uo response) {
                if (!this.b.d.get()) {
                    ...
                    try {
                        ...
                        we$e permissions = we.a(jsonObject);
                        this.b.c.a(accessToken, ul.i(), userId, permissions.a(), permissions.b(), AccessTokenSource.DEVICE_AUTH, null, null);
                        this.b.h.dismiss();
                    } catch (Throwable ex) {
