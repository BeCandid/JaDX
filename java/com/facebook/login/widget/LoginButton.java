...
public class LoginButton extends FacebookButtonBase {
    ...
    public class b implements OnClickListener {
        ...
        protected void a(Context context) {
            final wm loginManager = a();
            if (this.b.b) {
                String message;
                String logout = this.b.getResources().getString(uu$f.com_facebook_loginview_log_out_action);
                String cancel = this.b.getResources().getString(uu$f.com_facebook_loginview_cancel_action);
                Profile profile = Profile.a();
                if (profile == null || profile.c() == null) {
                    message = this.b.getResources().getString(uu$f.com_facebook_loginview_logged_in_using_facebook);
                } else {
                    message = String.format(this.b.getResources().getString(uu$f.com_facebook_loginview_logged_in_as), new Object[]{profile.c()});
                }
    ...
    static class a {
        ...
        public void b(List<String> permissions) {
            ...
            } else if (we.a((Collection) permissions)) {
    ...
    private void b() {
        switch (AnonymousClass3.a[this.i.ordinal()]) {
            case uu$h.com_facebook_profile_picture_view_com_facebook_is_cropped /*1*/:
                final String appId = we.a(getContext());
                ul.d().execute(new Runnable(this) {
                    final /* synthetic */ LoginButton b;

                    public void run() {
                        final we$b settings = we.a(appId, false);
            ...
            case uu$h.com_facebook_login_view_com_facebook_logout_text /*2*/:
                b(getResources().getString(uu$f.com_facebook_tooltip_default));
                return;
            default:
                return;
        }
    ...
    protected void a(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isInEditMode()) {
            setBackgroundColor(getResources().getColor(uu$a.com_facebook_blue));
    ...
    private void b(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, uu$h.com_facebook_login_view, defStyleAttr, defStyleRes);
        try {
            this.b = a.getBoolean(uu$h.com_facebook_login_view_com_facebook_confirm_logout, true);
            this.c = a.getString(uu$h.com_facebook_login_view_com_facebook_login_text);
            this.d = a.getString(uu$h.com_facebook_login_view_com_facebook_logout_text);
            this.i = ToolTipMode.a(a.getInt(uu$h.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.d.a()));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        String text = this.c;
        if (text == null) {
            text = resources.getString(uu$f.com_facebook_loginview_log_in_button_long);
            logInWidth = c(text);
            if (resolveSize(logInWidth, widthMeasureSpec) < logInWidth) {
                text = resources.getString(uu$f.com_facebook_loginview_log_in_button);
            }
        }
        logInWidth = c(text);
        text = this.d;
        if (text == null) {
            text = resources.getString(uu$f.com_facebook_loginview_log_out_button);
        }
    ...
    private void c() {
        ...
        if (!isInEditMode() && AccessToken.a() != null) {
            ...
            if (this.d != null) {
                ...
                charSequence = resources.getString(uu$f.com_facebook_loginview_log_out_button);
            }
            setText(charSequence);
        } else if (this.c != null) {
            setText(this.c);
        } else {
            String text = resources.getString(uu$f.com_facebook_loginview_log_in_button_long);
            int width = getWidth();
    ...
    void setLoginManager(wm loginManager) {
        this.m = loginManager;
    }
}
