...
public class ProfilePictureView extends FrameLayout {
    ...
    public final void setProfileId(String profileId) {
        boolean force = false;
        if (we.a(this.b) || !this.b.equalsIgnoreCase(profileId)) {
            b();
            force = true;
        }
        this.b = profileId;
    ...
    private void a(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, uu$h.com_facebook_profile_picture_view);
        setPresetSize(a.getInt(uu$h.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.e = a.getBoolean(uu$h.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
        a.recycle();
    }
    ...
    private void b() {
        ...
        if (this.k == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), a() ? uu$c.com_facebook_profile_picture_blank_square : uu$c.com_facebook_profile_picture_blank_portrait));
            return;
        }
        c();
    ...
    private void b(boolean allowCachedResponse) {
        vs request = new vs$a(getContext(), vs.a(this.b, this.d, this.c)).a(allowCachedResponse).a((Object) this).a(new vs$b(this) {
        ...
        if (response.a() == this.i) {
            ...
            if (error != null) {
                ...
                if (listener != null) {
                    ...
                    vx.a(LoggingBehavior.REQUESTS, 6, a, error.toString());
                }
    ...
    private int c(boolean forcePreset) {
        ...
        switch (this.h) {
            case -4:
                dimensionId = uu$b.com_facebook_profilepictureview_preset_size_large;
                break;
            case -3:
                dimensionId = uu$b.com_facebook_profilepictureview_preset_size_normal;
                break;
            case ev.POSITION_NONE /*-2*/:
                dimensionId = uu$b.com_facebook_profilepictureview_preset_size_small;
                break;
            case ev.POSITION_UNCHANGED /*-1*/:
                if (forcePreset) {
                    dimensionId = uu$b.com_facebook_profilepictureview_preset_size_normal;
