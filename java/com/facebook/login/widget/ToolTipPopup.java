...
public class ToolTipPopup {
    ...
    class a extends FrameLayout {
        ...
        private void c() {
            LayoutInflater.from(getContext()).inflate(uu$e.com_facebook_tooltip_bubble, this);
            this.b = (ImageView) findViewById(uu$d.com_facebook_tooltip_bubble_view_top_pointer);
            this.c = (ImageView) findViewById(uu$d.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.d = findViewById(uu$d.com_facebook_body_frame);
            this.e = (ImageView) findViewById(uu$d.com_facebook_button_xout);
        }
    ...
    public void a() {
        if (this.b.get() != null) {
            ...
            ((TextView) this.d.findViewById(uu$d.com_facebook_tooltip_bubble_view_text_body)).setText(this.a);
