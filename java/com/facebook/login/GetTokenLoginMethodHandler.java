...
import defpackage.wa$a;
import defpackage.we;
import defpackage.we$c;
...
class GetTokenLoginMethodHandler extends LoginMethodHandler {
    ...
    boolean a(final Request request) {
        this.c = new wj(this.b.b(), request.d());
        if (!this.c.a()) {
            return false;
        }
        this.b.k();
        this.c.a(new wa$a(this) {
    ...
    void c(final Request request, final Bundle result) {
        ...
        if (userId == null || userId.isEmpty()) {
            this.b.k();
            we.a(result.getString("com.facebook.platform.extra.ACCESS_TOKEN"), new we$c(this) {
