...
public class AppEvent implements Serializable {
    ...
    public AppEvent(String contextName, String eventName, Double valueToSum, Bundle parameters, boolean isImplicitlyLogged, UUID currentSessionId) {
        try {
            ...
            if (!this.b) {
                vx.a(LoggingBehavior.APP_EVENTS, "AppEvents", "Created app event '%s'", this.a.toString());
            }
        } catch (JSONException jsonException) {
            vx.a(LoggingBehavior.APP_EVENTS, "AppEvents", "JSON encoding for app event failed: '%s'", jsonException.toString());
            this.a = null;
        } catch (FacebookException e) {
            vx.a(LoggingBehavior.APP_EVENTS, "AppEvents", "Invalid app event name or parameter:", e.toString());
            this.a = null;
        }
    }
