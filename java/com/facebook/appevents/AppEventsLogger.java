...
public class AppEventsLogger {
    ...
    public void a(String eventName, Bundle parameters) {
        a(eventName, null, parameters, false, vc.a());
    }

    public void b() {
        uy.a(FlushReason.EXPLICIT);
    }
    ...
    public void a(String eventName, Double valueToSum, Bundle parameters) {
        a(eventName, valueToSum, parameters, true, vc.a());
    }
            ...
            d.scheduleAtFixedRate(new Runnable() {
                public void run() {
                    ...
                    synchronized (AppEventsLogger.g) {
                        for (AccessTokenAppIdPair accessTokenAppId : uy.a()) {
                            applicationIds.add(accessTokenAppId.b());
                        }
                    }
                    for (String applicationId : applicationIds) {
                        we.a(applicationId, true);
                    }
                }
    ...
    private static void a(Context context, AppEvent event, AccessTokenAppIdPair accessTokenAppId) {
        uy.a(accessTokenAppId, event);
        if (!event.b() && !i) {
            if (event.a() == "fb_mobile_activate_app") {
                i = true;
            } else {
                vx.a(LoggingBehavior.APP_EVENTS, "AppEvents", "Warning: Please call AppEventsLogger.activateApp(...)from the long-lived activity's onResume() methodbefore logging other app events.");
            }
        }
    }
