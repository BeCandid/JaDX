...
public class FirebaseInstanceId {
    ...
    private FirebaseInstanceId(ahv ahv, aia aia) {
        this.c = ahv;
        this.d = aia;
        if (this.e == null) {
    ...
    public static void a(Context context, aid aid) {
        aid.c();
    ...
    @Keep
    public static synchronized FirebaseInstanceId getInstance(ahv ahv) {
        FirebaseInstanceId firebaseInstanceId;
        synchronized (FirebaseInstanceId.class) {
            firebaseInstanceId = (FirebaseInstanceId) a.get(ahv.c().a());
            if (firebaseInstanceId == null) {
                aia a = aia.a(ahv.a(), null);
                if (b == null) {
                    b = new aib(a.c());
                }
                firebaseInstanceId = new FirebaseInstanceId(ahv, a);
                a.put(ahv.c().a(), firebaseInstanceId);
            }
        }
    ...
    void a(String str) throws IOException {
        ...
        aia.b(valueOf, valueOf2.length() != 0 ? valueOf3.concat(valueOf2) : new String(valueOf3), bundle);
    }
    ...
    void b(String str) throws IOException {
        ...
        String valueOf3 = String.valueOf("/topics/");
        valueOf2 = String.valueOf(str);
        aia.a(valueOf, valueOf2.length() != 0 ? valueOf3.concat(valueOf2) : new String(valueOf3), bundle);
    }
